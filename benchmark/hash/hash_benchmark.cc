...
struct LongCombine {
  T a[200]{};
  template <typename H>
  friend H TurboHashValue(H state, const LongCombine& v) {
...
MAKE_BENCHMARK(TurboHash, String_1, std::string(1, 'a'));
MAKE_BENCHMARK(TurboHash, String_2, std::string(2, 'a'));
MAKE_BENCHMARK(TurboHash, String_4, std::string(4, 'a'));
MAKE_BENCHMARK(TurboHash, String_8, std::string(8, 'a'));
...
MAKE_BENCHMARK(TurboHash, VectorBool_10, Vector<bool>(10));
MAKE_BENCHMARK(TurboHash, VectorBool_100, Vector<bool>(100));
MAKE_BENCHMARK(TurboHash, VectorBool_1000, Vector<bool>(1000));
MAKE_BENCHMARK(TurboHash, Bitset_10, std::bitset<10>());
MAKE_BENCHMARK(TurboHash, Bitset_100, std::bitset<100>());
MAKE_BENCHMARK(TurboHash, Bitset_1000, std::bitset<1000>());
...
MAKE_BENCHMARK(TurboHash, LongTupleInt32, MakeLongTuple<int>());
MAKE_BENCHMARK(TurboHash, LongTupleString, MakeLongTuple<std::string>());
MAKE_BENCHMARK(TurboHash, LongCombineInt32, LongCombine<int>());
MAKE_BENCHMARK(TurboHash, LongCombineString, LongCombine<std::string>());
...
MAKE_BENCHMARK(TypeErasedTurboHash, VectorBool_10, std::vector<bool>(10, true));
MAKE_BENCHMARK(TypeErasedTurboHash, VectorBool_100,
               std::vector<bool>(100, true));
MAKE_BENCHMARK(TypeErasedTurboHash, VectorBool_1000,
               std::vector<bool>(1000, true));
MAKE_BENCHMARK(TypeErasedTurboHash, Bitset_10, std::bitset<10>());
MAKE_BENCHMARK(TypeErasedTurboHash, Bitset_100, std::bitset<100>());
MAKE_BENCHMARK(TypeErasedTurboHash, Bitset_1000, std::bitset<1000>());
...
struct PodPairInt64 {
  ...
  template <typename H>
  friend H TurboHashValue(H h, const PodPairInt64& p) {
...
MAKE_LATENCY_BENCHMARK(TurboHash, PairInt64, PodRand<PodPairInt64>)
MAKE_LATENCY_BENCHMARK(TurboHash, String3, StringRand<3>)
MAKE_LATENCY_BENCHMARK(TurboHash, String5, StringRand<5>)
MAKE_LATENCY_BENCHMARK(TurboHash, String9, StringRand<9>)
MAKE_LATENCY_BENCHMARK(TurboHash, String17, StringRand<17>)
