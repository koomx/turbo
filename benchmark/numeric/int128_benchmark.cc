...
BENCHMARK_TEMPLATE(BM_DivideClass128UniformDivisor, turbo::uint128);
BENCHMARK_TEMPLATE(BM_DivideClass128UniformDivisor, turbo::int128);
...
BENCHMARK_TEMPLATE(BM_RemainderClass128UniformDivisor, turbo::uint128);
BENCHMARK_TEMPLATE(BM_RemainderClass128UniformDivisor, turbo::int128);
...
BENCHMARK_TEMPLATE(BM_DivideClass128SmallDivisor, turbo::uint128);
BENCHMARK_TEMPLATE(BM_DivideClass128SmallDivisor, turbo::int128);
...
BENCHMARK_TEMPLATE(BM_RemainderClass128SmallDivisor, turbo::uint128);
BENCHMARK_TEMPLATE(BM_RemainderClass128SmallDivisor, turbo::int128);
