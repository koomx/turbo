...
#include <tests/base/internal/atomic_hook_test_helper.h>
...
TEST(AtomicHookTest, NoDefaultFunction) {
  KUMO_INTERNAL_ATOMIC_HOOK_ATTRIBUTES static turbo::base_internal::AtomicHook<
      void (*)(int)>
      hook;
  value = 0;
...
KUMO_CONST_INIT int override_func_calls = 0;
