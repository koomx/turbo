...
int very_long_int_variable_name KUMO_UNIQUE_SMALL_NAME() = 0;
char very_long_str_variable_name[] KUMO_UNIQUE_SMALL_NAME() = "abc";
...
int VeryLongFreeFunctionName() KUMO_UNIQUE_SMALL_NAME();
...
struct VeryLongStructName {
  ...
  int VeryLongMethodName() KUMO_UNIQUE_SMALL_NAME();

  static int VeryLongStaticMethodName() KUMO_UNIQUE_SMALL_NAME();
