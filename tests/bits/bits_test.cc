...
TEST(Byteswap, Constexpr) {
  static_assert(turbo::byteswap<int8_t>(0x12) == 0x12);
  static_assert(turbo::byteswap<int16_t>(0x1234) == 0x3412);
  static_assert(turbo::byteswap<int32_t>(0x12345678) == 0x78563412);
  static_assert(turbo::byteswap<int64_t>(0x123456789abcdef0) ==
                static_cast<int64_t>(0xf0debc9a78563412));
  static_assert(turbo::byteswap<uint8_t>(0x21) == 0x21);
  static_assert(turbo::byteswap<uint16_t>(0x4321) == 0x2143);
  static_assert(turbo::byteswap<uint32_t>(0x87654321) == 0x21436587);
  static_assert(turbo::byteswap<uint64_t>(0xfedcba9876543210) ==
                static_cast<uint64_t>(0x1032547698badcfe));
  static_assert(turbo::byteswap<int32_t>(static_cast<int32_t>(0xdeadbeef)) ==
...
TEST(Byteswap, NotConstexpr) {
  ...
  EXPECT_EQ(turbo::byteswap<int8_t>(a), 0x12);
  EXPECT_EQ(turbo::byteswap<int16_t>(b), 0x3412);
  EXPECT_EQ(turbo::byteswap(c), 0x78563412);
  EXPECT_EQ(turbo::byteswap(d), 0xf0debc9a78563412);
  EXPECT_EQ(turbo::byteswap<uint8_t>(e), 0x21);
  EXPECT_EQ(turbo::byteswap<uint16_t>(f), 0x2143);
  EXPECT_EQ(turbo::byteswap(g), 0x21436587);
  EXPECT_EQ(turbo::byteswap(h), 0x1032547698badcfe);
  EXPECT_EQ(turbo::byteswap(turbo::byteswap<int8_t>(a)), a);
  EXPECT_EQ(turbo::byteswap(turbo::byteswap<int16_t>(b)), b);
  EXPECT_EQ(turbo::byteswap(turbo::byteswap(c)), c);
  EXPECT_EQ(turbo::byteswap(turbo::byteswap(d)), d);
  EXPECT_EQ(turbo::byteswap(turbo::byteswap<uint8_t>(e)), e);
  EXPECT_EQ(turbo::byteswap(turbo::byteswap<uint16_t>(f)), f);
  EXPECT_EQ(turbo::byteswap(turbo::byteswap(g)), g);
  EXPECT_EQ(turbo::byteswap(turbo::byteswap(h)), h);
  EXPECT_EQ(turbo::byteswap<uint32_t>(0xdeadbeef), 0xefbeadde);
  EXPECT_EQ(turbo::byteswap<const uint32_t>(0xdeadbeef), 0xefbeadde);
}
