...
#include <turbo/cctz/civil_time.h>
...
void TestFormatSpecifier(time_point<D> tp, time_zone tz, const std::string& fmt,
  ...
  EXPECT_EQ(ans, turbo::time_internal::cctz::format(fmt, tp, tz)) << fmt;
  EXPECT_EQ("xxx " + ans,
            turbo::time_internal::cctz::format("xxx " + fmt, tp, tz));
  EXPECT_EQ(ans + " yyy",
            turbo::time_internal::cctz::format(fmt + " yyy", tp, tz));
  EXPECT_EQ("xxx " + ans + " yyy",
            turbo::time_internal::cctz::format("xxx " + fmt + " yyy", tp, tz));
}
...
TEST(str_printf_to, TimePointResolution) {
  ...
  EXPECT_EQ("03:04:05.123456789",
            turbo::time_internal::cctz::format(
  ...
  EXPECT_EQ(
      "03:04:05",
      turbo::time_internal::cctz::format(
          kFmt, chrono::time_point_cast<turbo::time_internal::cctz::seconds>(t0),
          utc));
  EXPECT_EQ("03:04:00",
            turbo::time_internal::cctz::format(
...
TEST(str_printf_to, TimePointExtendedResolution) {
  const char kFmt[] = "%H:%M:%E*S";
  const time_zone utc = utc_time_zone();
...
TEST(str_printf_to, Basics) {
  time_zone tz = utc_time_zone();
  time_point<chrono::nanoseconds> tp = chrono::system_clock::from_time_t(0);

  // Start with basic edge cases.
  EXPECT_EQ("", turbo::time_internal::cctz::format("", tp, tz));
  EXPECT_EQ(" ", turbo::time_internal::cctz::format(" ", tp, tz));
  EXPECT_EQ("  ", turbo::time_internal::cctz::format("  ", tp, tz));
  EXPECT_EQ("xxx", turbo::time_internal::cctz::format("xxx", tp, tz));
  std::string big(128, 'x');
  EXPECT_EQ(big, turbo::time_internal::cctz::format(big, tp, tz));
  // Cause the 1024-byte buffer to grow.
  std::string bigger(100000, 'x');
  EXPECT_EQ(bigger, turbo::time_internal::cctz::format(bigger, tp, tz));
  ...
  EXPECT_EQ("1970-01-01",
            turbo::time_internal::cctz::format("%Y-%m-%d", tp, tz));
  EXPECT_EQ("13:04:05", turbo::time_internal::cctz::format("%H:%M:%S", tp, tz));
  EXPECT_EQ("13:04:05.006",
            turbo::time_internal::cctz::format("%H:%M:%E3S", tp, tz));
  EXPECT_EQ("13:04:05.006007",
            turbo::time_internal::cctz::format("%H:%M:%E6S", tp, tz));
  EXPECT_EQ("13:04:05.006007008",
            turbo::time_internal::cctz::format("%H:%M:%E9S", tp, tz));
}

TEST(str_printf_to, PosixConversions) {
...
TEST(str_printf_to, LocaleSpecific) {
  const time_zone tz = utc_time_zone();
  ...
  const std::string s =
      turbo::time_internal::cctz::format("%c", tp, utc_time_zone());
...
TEST(str_printf_to, ExtendedSeconds) {
  const time_zone tz = utc_time_zone();

  // No subseconds.
  time_point<chrono::nanoseconds> tp = chrono::system_clock::from_time_t(0);
  tp += chrono::seconds(5);
  EXPECT_EQ("05", turbo::time_internal::cctz::format("%E*S", tp, tz));
  EXPECT_EQ("05", turbo::time_internal::cctz::format("%E0S", tp, tz));
  EXPECT_EQ("05.0", turbo::time_internal::cctz::format("%E1S", tp, tz));
  EXPECT_EQ("05.00", turbo::time_internal::cctz::format("%E2S", tp, tz));
  EXPECT_EQ("05.000", turbo::time_internal::cctz::format("%E3S", tp, tz));
  EXPECT_EQ("05.0000", turbo::time_internal::cctz::format("%E4S", tp, tz));
  EXPECT_EQ("05.00000", turbo::time_internal::cctz::format("%E5S", tp, tz));
  EXPECT_EQ("05.000000", turbo::time_internal::cctz::format("%E6S", tp, tz));
  EXPECT_EQ("05.0000000", turbo::time_internal::cctz::format("%E7S", tp, tz));
  EXPECT_EQ("05.00000000", turbo::time_internal::cctz::format("%E8S", tp, tz));
  EXPECT_EQ("05.000000000", turbo::time_internal::cctz::format("%E9S", tp, tz));
  EXPECT_EQ("05.0000000000",
            turbo::time_internal::cctz::format("%E10S", tp, tz));
  EXPECT_EQ("05.00000000000",
            turbo::time_internal::cctz::format("%E11S", tp, tz));
  EXPECT_EQ("05.000000000000",
            turbo::time_internal::cctz::format("%E12S", tp, tz));
  EXPECT_EQ("05.0000000000000",
            turbo::time_internal::cctz::format("%E13S", tp, tz));
  EXPECT_EQ("05.00000000000000",
            turbo::time_internal::cctz::format("%E14S", tp, tz));
  EXPECT_EQ("05.000000000000000",
            turbo::time_internal::cctz::format("%E15S", tp, tz));

  // With subseconds.
  tp += chrono::milliseconds(6) + chrono::microseconds(7) +
        chrono::nanoseconds(8);
  EXPECT_EQ("05.006007008", turbo::time_internal::cctz::format("%E*S", tp, tz));
  EXPECT_EQ("05", turbo::time_internal::cctz::format("%E0S", tp, tz));
  EXPECT_EQ("05.0", turbo::time_internal::cctz::format("%E1S", tp, tz));
  EXPECT_EQ("05.00", turbo::time_internal::cctz::format("%E2S", tp, tz));
  EXPECT_EQ("05.006", turbo::time_internal::cctz::format("%E3S", tp, tz));
  EXPECT_EQ("05.0060", turbo::time_internal::cctz::format("%E4S", tp, tz));
  EXPECT_EQ("05.00600", turbo::time_internal::cctz::format("%E5S", tp, tz));
  EXPECT_EQ("05.006007", turbo::time_internal::cctz::format("%E6S", tp, tz));
  EXPECT_EQ("05.0060070", turbo::time_internal::cctz::format("%E7S", tp, tz));
  EXPECT_EQ("05.00600700", turbo::time_internal::cctz::format("%E8S", tp, tz));
  EXPECT_EQ("05.006007008", turbo::time_internal::cctz::format("%E9S", tp, tz));
  ...
  EXPECT_EQ("1969-12-31 23:59:59.999999",
            turbo::time_internal::cctz::format("%Y-%m-%d %H:%M:%E*S", tp, tz));
...
TEST(str_printf_to, ExtendedSubeconds) {
  const time_zone tz = utc_time_zone();

  // No subseconds.
  time_point<chrono::nanoseconds> tp = chrono::system_clock::from_time_t(0);
  tp += chrono::seconds(5);
  EXPECT_EQ("0", turbo::time_internal::cctz::format("%E*f", tp, tz));
  EXPECT_EQ("", turbo::time_internal::cctz::format("%E0f", tp, tz));
  EXPECT_EQ("0", turbo::time_internal::cctz::format("%E1f", tp, tz));
  EXPECT_EQ("00", turbo::time_internal::cctz::format("%E2f", tp, tz));
  EXPECT_EQ("000", turbo::time_internal::cctz::format("%E3f", tp, tz));
  EXPECT_EQ("0000", turbo::time_internal::cctz::format("%E4f", tp, tz));
  EXPECT_EQ("00000", turbo::time_internal::cctz::format("%E5f", tp, tz));
  EXPECT_EQ("000000", turbo::time_internal::cctz::format("%E6f", tp, tz));
  EXPECT_EQ("0000000", turbo::time_internal::cctz::format("%E7f", tp, tz));
  EXPECT_EQ("00000000", turbo::time_internal::cctz::format("%E8f", tp, tz));
  EXPECT_EQ("000000000", turbo::time_internal::cctz::format("%E9f", tp, tz));
  EXPECT_EQ("0000000000", turbo::time_internal::cctz::format("%E10f", tp, tz));
  EXPECT_EQ("00000000000", turbo::time_internal::cctz::format("%E11f", tp, tz));
  EXPECT_EQ("000000000000", turbo::time_internal::cctz::format("%E12f", tp, tz));
  EXPECT_EQ("0000000000000",
            turbo::time_internal::cctz::format("%E13f", tp, tz));
  EXPECT_EQ("00000000000000",
            turbo::time_internal::cctz::format("%E14f", tp, tz));
  EXPECT_EQ("000000000000000",
            turbo::time_internal::cctz::format("%E15f", tp, tz));

  // With subseconds.
  tp += chrono::milliseconds(6) + chrono::microseconds(7) +
        chrono::nanoseconds(8);
  EXPECT_EQ("006007008", turbo::time_internal::cctz::format("%E*f", tp, tz));
  EXPECT_EQ("", turbo::time_internal::cctz::format("%E0f", tp, tz));
  EXPECT_EQ("0", turbo::time_internal::cctz::format("%E1f", tp, tz));
  EXPECT_EQ("00", turbo::time_internal::cctz::format("%E2f", tp, tz));
  EXPECT_EQ("006", turbo::time_internal::cctz::format("%E3f", tp, tz));
  EXPECT_EQ("0060", turbo::time_internal::cctz::format("%E4f", tp, tz));
  EXPECT_EQ("00600", turbo::time_internal::cctz::format("%E5f", tp, tz));
  EXPECT_EQ("006007", turbo::time_internal::cctz::format("%E6f", tp, tz));
  EXPECT_EQ("0060070", turbo::time_internal::cctz::format("%E7f", tp, tz));
  EXPECT_EQ("00600700", turbo::time_internal::cctz::format("%E8f", tp, tz));
  EXPECT_EQ("006007008", turbo::time_internal::cctz::format("%E9f", tp, tz));
  EXPECT_EQ("0060070080", turbo::time_internal::cctz::format("%E10f", tp, tz));
  EXPECT_EQ("00600700800", turbo::time_internal::cctz::format("%E11f", tp, tz));
  EXPECT_EQ("006007008000", turbo::time_internal::cctz::format("%E12f", tp, tz));
  ...
  EXPECT_EQ(
      ...
      turbo::time_internal::cctz::format("%Y-%m-%d %H:%M:%S.%E*f", tp, tz));
...
TEST(str_printf_to, CompareExtendSecondsVsSubseconds) {
  const time_zone tz = utc_time_zone();
  ...
  EXPECT_EQ("05", turbo::time_internal::cctz::format(fmt_A("*"), tp, tz));
  EXPECT_EQ("05.0", turbo::time_internal::cctz::format(fmt_B("*"), tp, tz));
  // ... %E0S and %S.%E0f are different.
  EXPECT_EQ("05", turbo::time_internal::cctz::format(fmt_A("0"), tp, tz));
  EXPECT_EQ("05.", turbo::time_internal::cctz::format(fmt_B("0"), tp, tz));
  // ... %E<prec>S and %S.%E<prec>f are the same for prec in [1:15].
  for (int prec = 1; prec <= 15; ++prec) {
    const std::string a =
        turbo::time_internal::cctz::format(fmt_A(std::to_string(prec)), tp, tz);
    const std::string b =
        turbo::time_internal::cctz::format(fmt_B(std::to_string(prec)), tp, tz);
  ...
  EXPECT_EQ("05.006007008",
            turbo::time_internal::cctz::format(fmt_A("*"), tp, tz));
  EXPECT_EQ("05.006007008",
            turbo::time_internal::cctz::format(fmt_B("*"), tp, tz));
  // ... %E0S and %S.%E0f are different.
  EXPECT_EQ("05", turbo::time_internal::cctz::format(fmt_A("0"), tp, tz));
  EXPECT_EQ("05.", turbo::time_internal::cctz::format(fmt_B("0"), tp, tz));
  // ... %E<prec>S and %S.%E<prec>f are the same for prec in [1:15].
...
TEST(str_printf_to, ExtendedOffset) {
...
TEST(str_printf_to, ExtendedSecondOffset) {
  const auto tp = chrono::system_clock::from_time_t(0);
...
TEST(str_printf_to, ExtendedYears) {
  const time_zone utc = utc_time_zone();
  ...
  EXPECT_EQ("-9991127", turbo::time_internal::cctz::format(e4y_fmt, tp, utc));
  tp = convert(civil_second(-99, 11, 27, 0, 0, 0), utc);
  EXPECT_EQ("-0991127", turbo::time_internal::cctz::format(e4y_fmt, tp, utc));
  tp = convert(civil_second(-9, 11, 27, 0, 0, 0), utc);
  EXPECT_EQ("-0091127", turbo::time_internal::cctz::format(e4y_fmt, tp, utc));
  tp = convert(civil_second(-1, 11, 27, 0, 0, 0), utc);
  EXPECT_EQ("-0011127", turbo::time_internal::cctz::format(e4y_fmt, tp, utc));
  tp = convert(civil_second(0, 11, 27, 0, 0, 0), utc);
  EXPECT_EQ("00001127", turbo::time_internal::cctz::format(e4y_fmt, tp, utc));
  tp = convert(civil_second(1, 11, 27, 0, 0, 0), utc);
  EXPECT_EQ("00011127", turbo::time_internal::cctz::format(e4y_fmt, tp, utc));
  tp = convert(civil_second(9, 11, 27, 0, 0, 0), utc);
  EXPECT_EQ("00091127", turbo::time_internal::cctz::format(e4y_fmt, tp, utc));
  tp = convert(civil_second(99, 11, 27, 0, 0, 0), utc);
  EXPECT_EQ("00991127", turbo::time_internal::cctz::format(e4y_fmt, tp, utc));
  tp = convert(civil_second(999, 11, 27, 0, 0, 0), utc);
  EXPECT_EQ("09991127", turbo::time_internal::cctz::format(e4y_fmt, tp, utc));
  tp = convert(civil_second(9999, 11, 27, 0, 0, 0), utc);
  EXPECT_EQ("99991127", turbo::time_internal::cctz::format(e4y_fmt, tp, utc));

  // When the year is outside [-999:9999], more than 4 chars are produced.
  tp = convert(civil_second(-1000, 11, 27, 0, 0, 0), utc);
  EXPECT_EQ("-10001127", turbo::time_internal::cctz::format(e4y_fmt, tp, utc));
  tp = convert(civil_second(10000, 11, 27, 0, 0, 0), utc);
  EXPECT_EQ("100001127", turbo::time_internal::cctz::format(e4y_fmt, tp, utc));
}

TEST(str_printf_to, RFC3339Format) {
  time_zone tz;
  ...
  EXPECT_EQ("1977-06-28T09:08:07-07:00",
            turbo::time_internal::cctz::format(RFC3339_full, tp, tz));
  EXPECT_EQ("1977-06-28T09:08:07-07:00",
            turbo::time_internal::cctz::format(RFC3339_sec, tp, tz));
...
TEST(str_printf_to, RFC1123Format) {  // locale specific
  time_zone tz;
  EXPECT_TRUE(load_time_zone("America/Los_Angeles", &tz));

  auto tp = convert(civil_second(1977, 6, 28, 9, 8, 7), tz);
  EXPECT_EQ("Tue, 28 Jun 1977 09:08:07 -0700",
            turbo::time_internal::cctz::format(RFC1123_full, tp, tz));
  EXPECT_EQ("28 Jun 1977 09:08:07 -0700",
            turbo::time_internal::cctz::format(RFC1123_no_wday, tp, tz));
}

TEST(str_printf_to, Week) {
  const time_zone utc = utc_time_zone();

  auto tp = convert(civil_second(2017, 1, 1, 0, 0, 0), utc);
  EXPECT_EQ("2017-01-7",
            turbo::time_internal::cctz::format("%Y-%U-%u", tp, utc));
  EXPECT_EQ("2017-00-0",
            turbo::time_internal::cctz::format("%Y-%W-%w", tp, utc));
...
TEST(str_printf_to, NULsInFormatString) {
  time_zone tz = utc_time_zone();
  time_point<chrono::nanoseconds> tp = chrono::system_clock::from_time_t(0);

  // All NULs.
  std::string nuls(32, '\0');
  EXPECT_EQ(nuls, turbo::time_internal::cctz::format(nuls, tp, tz));
  ...
  EXPECT_EQ(percent_nul,
            turbo::time_internal::cctz::format(percent_nul, tp, tz));
  ...
  EXPECT_EQ(percent_E_nul,
            turbo::time_internal::cctz::format(percent_E_nul, tp, tz));
  std::string percent_O_nul("abc%O\0xyz", 9);
  EXPECT_EQ(percent_O_nul,
            turbo::time_internal::cctz::format(percent_O_nul, tp, tz));
#endif
}
...
TEST(Parse, TimePointResolution) {
  ...
  EXPECT_EQ("03:04:05.123456789",
            turbo::time_internal::cctz::format(kFmt, tp_ns, utc));
  ...
  EXPECT_EQ("03:04:05.123456",
            turbo::time_internal::cctz::format(kFmt, tp_us, utc));
...
TEST(Parse, MaxRange) {
  ...
  EXPECT_EQ(tp, time_point<turbo::time_internal::cctz::seconds>::max());
  EXPECT_FALSE(
  ...
  EXPECT_EQ(tp, time_point<turbo::time_internal::cctz::seconds>::min());
  EXPECT_FALSE(
...
TEST(Parse, TimePointOverflow) {
  ...
  EXPECT_EQ("2262-04-11T23:47:16.854775807+00:00",
            turbo::time_internal::cctz::format(RFC3339_full, tp, utc));
#if 0
  ...
  EXPECT_EQ("1970-01-01T00:02:07+00:00",
            turbo::time_internal::cctz::format(RFC3339_full, stp, utc));
  ...
  EXPECT_EQ("1970-01-01T02:07:00+00:00",
            turbo::time_internal::cctz::format(RFC3339_full, mtp, utc));
...
TEST(FormatParse, RoundTrip) {
  ...
  // No format specifiers, but include NUL.
  {
    ...
    const auto s = turbo::time_internal::cctz::format(fmt, in, lax);
  ...
  // RFC3339, which renders subseconds.
  {
    time_point<chrono::nanoseconds> out;
    const auto s =
        turbo::time_internal::cctz::format(RFC3339_full, in + subseconds, lax);
  ...
  {
    time_point<chrono::nanoseconds> out;
    const auto s = turbo::time_internal::cctz::format(RFC1123_full, in, lax);
  ...
  // but only in the 0-offset timezone.
  {
    ...
    const auto s = turbo::time_internal::cctz::format("%c", in, utc);
...
TEST(FormatParse, RoundTripDistantFuture) {
  ...
  const std::string s =
      turbo::time_internal::cctz::format(RFC3339_full, in, utc);
