...
template <class T> bool lexical_cast(const std::string &input, badlywrapped<T> &output) {
    ...
    // an overload for `spair` type, which is not in `xcli::detail`.
...
/// Another wrapper to test that specializing xcli::detail::lexical_cast works
struct anotherstring {
    anotherstring() = default;
    std::string s{};
};

// This is a custom converter done via specializing the xcli::detail::lexical_cast template. This was the recommended
...
template <class T, xcli::enable_if_t<is_my_lexical_cast_enabled<T>::value, xcli::detail::enabler> = xcli::detail::dummy>
...
static_assert(xcli::detail::is_direct_constructible<objWrapper<std::string>, std::string>::value,
...
static_assert(xcli::detail::is_direct_constructible<objWrapper<double>, double>::value,
              "double wrapper isn't properly assignable");

static_assert(!xcli::detail::is_direct_constructible<objWrapper<double>, int>::value,
              "double wrapper can be assigned from int");

static_assert(!xcli::detail::is_istreamable<objWrapper<double>>::value,
...
static_assert(xcli::detail::is_direct_constructible<objWrapper<int>, int>::value,
              "int wrapper is not constructible from int64");

static_assert(!xcli::detail::is_direct_constructible<objWrapper<int>, double>::value,
              "int wrapper is constructible from double");

static_assert(!xcli::detail::is_istreamable<objWrapper<int>>::value,
...
static_assert(!xcli::detail::is_direct_constructible<objWrapper<float>, int>::value,
              "float wrapper is constructible from int");
static_assert(!xcli::detail::is_direct_constructible<objWrapper<float>, double>::value,
              "float wrapper is constructible from double");

static_assert(!xcli::detail::is_istreamable<objWrapper<float>>::value,
