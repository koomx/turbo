...
#include <turbo/container/linked_hash_set.h>
...
#include <tests/container/internal/unordered_set_constructor_test.h>
#include <tests/container/internal/unordered_set_lookup_test.h>
#include <tests/container/internal/unordered_set_members_test.h>
#include <tests/container/internal/unordered_set_modifiers_test.h>
#include <string_view>
...
TEST(LinkedHashSetTest, CanInsertTransparent) {
  ...
  s.insert(std::string_view("foo"));
  s.insert(std::string_view("bar"));
  s.insert(std::string_view("foo"));
...
TEST(LinkedHashSetTest, EmplaceString) {
  ...
  linked_hash_set<std::string_view> hs(v.begin(), v.end());
