...
using ::turbo::cordrep_testing::AutoUnref;
using ::turbo::cordrep_testing::CordCollectRepsIf;
using ::turbo::cordrep_testing::CordToString;
using ::turbo::cordrep_testing::CordVisitReps;
...
TEST(CordRepBtreeTest, CheckAssertValidShallowVsDeep) {
  ...
  auto cleanup = turbo::MakeCleanup([exhaustive_validation] {
