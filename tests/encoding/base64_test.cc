...
#include <turbo/encoding/internal/base64_test_common.h>
...
namespace turbo {
    ...
    TEST(Base64, DISABLED_HugeData) {
        ...
        std::string escaped = turbo::base64_encode(huge);
    ...
    void TestEscapeAndUnescape() {
        ...
        for (const auto& tc : base64_tests) {
            ...
            encoded = turbo::base64_encode(tc.plaintext);
            ...
            encoded = turbo::web_safe_base64_encode(tc.plaintext);
        ...
        for (const auto& tc : turbo::encoding_internal::base64_strings()) {
            StringType buffer;
            buffer = turbo::web_safe_base64_encode(tc.plaintext);
