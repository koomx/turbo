...
const std::string& GetTestTempDir() {
  static std::string* temp_dir_name = []() -> std::string* {
    ...
    if (res->empty()) {
      KLOG(FATAL) << "Failed to make temporary directory for data files";
    }
...
void InvokeParseTurboOnly(const char* (&in_argv)[N]) {
  ...
  turbo::ParseAbseilFlagsOnly(2, const_cast<char**>(in_argv), positional_args,
                             unrecognized_flags);
}
...
TEST_F(ParseTest, ParseAbseilFlagsOnlySuccess) {
  ...
  turbo::ParseAbseilFlagsOnly(13, const_cast<char**>(in_args), positional_args,
                             unrecognized_flags);
...
TEST_F(ParseTest, UndefOkFlagsAreIgnored) {
  ...
  turbo::ParseAbseilFlagsOnly(6, const_cast<char**>(in_args), positional_args,
                             unrecognized_flags);
...
TEST_F(ParseTest, AllUndefOkFlagsAreIgnored) {
  ...
  turbo::ParseAbseilFlagsOnly(8, const_cast<char**>(in_args), positional_args,
                             unrecognized_flags);
  EXPECT_THAT(positional_args,
