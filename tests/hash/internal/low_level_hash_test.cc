...
TEST(LowLevelHashTest, VerifyGolden) {
...
#if KUMO_ENDIAN_BIG || !KUMO_HAVE_INTRINSIC_INT128 || \
  ...
  auto hash_fn = [](std::string_view s, uint64_t state) {
    return turbo::hash_internal::CombineLargeContiguousImplOn64BitLengthGt32(
