...
TEST_F(ContainerLoggingTest, FullContainer) {
  ...
  expected1 = "[\n" + turbo::StrJoin(ints, "\n") + "\n]";
  expected2 = "[" + turbo::StrJoin(ints, ", ") + "]";
  expected3 = "[\n" + turbo::StrJoin(ints100, "\n") + "\n...\n]";
  expected4 = "[" + turbo::StrJoin(ints100, ", ") + ", ...]";
  expected5 = turbo::StrJoin(ints100, " ") + " ...";
  expected6 = "[\n" + turbo::StrJoin(ints, "\n") + "\n]";
  expected7 = "[\n" + turbo::StrJoin(ints123, "\n") + "\n...\n]";
  expected8 = "[" + turbo::StrJoin(ints, ", ") + "]";
  expected9 = "[" + turbo::StrJoin(ints123, ", ") + ", ...]";
