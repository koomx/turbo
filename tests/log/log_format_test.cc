...
TEST(SourceLocationTest, str_printf_to) {
  turbo::ScopedMockLog test_sink(turbo::MockLogDefault::kDisallowUnexpected);
  EXPECT_CALL(test_sink, send).Times(0);
...
// See details in turbo/strings/internal/utf8_test.cc.
//
// clang-format off
#define TURBO_LOG_INTERNAL_WIDE_LITERAL L"Holá €1 你好 שָׁלוֹם 👍🏻🇺🇸👩‍❤️‍💋‍👨 中"
#define TURBO_LOG_INTERNAL_UTF8_LITERAL u8"Holá €1 你好 שָׁלוֹם 👍🏻🇺🇸👩‍❤️‍💋‍👨 中"
// clang-format on

std::string_view GetUtf8TestString() {
  ...
  // it in a `string_view`.
  static const std::string_view kUtf8TestString(
      reinterpret_cast<const char*>(TURBO_LOG_INTERNAL_UTF8_LITERAL),
      sizeof(TURBO_LOG_INTERNAL_UTF8_LITERAL) - 1);
...
TYPED_TEST(WideStringLogFormatTest, NonLiterals) {
  ...
  TypeParam value = TURBO_LOG_INTERNAL_WIDE_LITERAL;
  std::string_view utf8_value = GetUtf8TestString();
...
TEST(WideStringLogFormatTest, StringView) {
  ...
  std::wstring_view value = TURBO_LOG_INTERNAL_WIDE_LITERAL;
  std::string_view utf8_value = GetUtf8TestString();
...
TEST(WideStringLogFormatTest, Literal) {
  ...
  test_sink.StartCapturingLogs();
  KLOG(INFO) << TURBO_LOG_INTERNAL_WIDE_LITERAL;
}

#undef TURBO_LOG_INTERNAL_WIDE_LITERAL
#undef TURBO_LOG_INTERNAL_UTF8_LITERAL
...
TYPED_TEST(WideStringLogFormatTest, IsolatedLowSurrogatesAreReplaced) {
  ...
  std::string_view utf8_value = "AAA � BBB";
...
TYPED_TEST(WideStringLogFormatTest,
  ...
  // NOLINTNEXTLINE(readability/utf8)
  std::string_view utf8_value = "AAA �𐀀 BBB";
...
TYPED_TEST(WideStringLogFormatTest,
  ...
  // NOLINTNEXTLINE(readability/utf8)
  std::string_view utf8_value = "AAA �";
...
struct Point {
  ...
  friend void turbo_stringify(Sink& sink, const Point& p) {
    turbo::str_printf_to(&sink, "(%d, %d)", p.x, p.y);
  }
...
KUMO_ATTRIBUTE_UNUSED std::ostream& operator<<(
    std::ostream& os, const PointWithTurboStringifiyAndOstream&) {
  return os << "Default to turbo_stringify()";
}
...
struct PointStreamsNothing {
  template <typename Sink>
  friend void turbo_stringify(Sink&, const PointStreamsNothing&) {}
...
TEST(ManipulatorLogFormatTest, BoolAlphaTrue) {
  ...
  test_sink.StartCapturingLogs();
  KLOG(INFO) << std::noboolalpha << value << " "  //
            << std::boolalpha << value << " "    //
            << std::noboolalpha << value;
}
...
TEST(ManipulatorLogFormatTest, ShowPoint) {
  ...
  test_sink.StartCapturingLogs();
  KLOG(INFO) << std::noshowpoint << value << " "  //
            << std::showpoint << value << " "    //
            << std::noshowpoint << value;
}
...
TEST(ManipulatorLogFormatTest, UppercaseFloat) {
  ...
  test_sink.StartCapturingLogs();
  KLOG(INFO) << std::nouppercase << value << " "  //
            << std::uppercase << value << " "    //
            << std::nouppercase << value;
}
...
TEST(ManipulatorLogFormatTest, Dec) {
  ...
  test_sink.StartCapturingLogs();
  KLOG(INFO) << std::hex << std::dec << value;
}
...
TEST(ManipulatorLogFormatTest, ScientificFloat) {
  ...
  test_sink.StartCapturingLogs();
  KLOG(INFO) << std::scientific << value;
}
...
TEST(ManipulatorLogFormatTest, FixedAndScientificFloat) {
  ...
  KLOG(INFO) << std::setiosflags(std::ios_base::scientific |
                                std::ios_base::fixed)
            << value;
}
#endif
...
TEST(ManipulatorLogFormatTest, DefaultFloatFloat) {
  ...
  test_sink.StartCapturingLogs();
  KLOG(INFO) << std::hexfloat << std::defaultfloat << value;
}
...
TEST(ManipulatorLogFormatTest, Ends) {
  ...
  EXPECT_CALL(test_sink,
              send(AllOf(TextMessage(MatchesOstream(comparison_stream)),
                         ...
                         ENCODED_MESSAGE(HasValues(ElementsAre(
                             ValueWithStr(Eq(std::string_view("\0", 1)))))))));
...
TEST(ManipulatorLogFormatTest, SetIosFlags) {
  ...
  test_sink.StartCapturingLogs();
  KLOG(INFO) << std::resetiosflags(std::ios_base::basefield)
            << std::setiosflags(std::ios_base::hex) << value << " "  //
            << std::resetiosflags(std::ios_base::basefield)
            << std::setiosflags(std::ios_base::dec) << value;
}
...
TEST(ManipulatorLogFormatTest, SetBase) {
  ...
  test_sink.StartCapturingLogs();
  KLOG(INFO) << std::setbase(16) << value << " "  //
            << std::setbase(0) << value;
}
...
TEST(ManipulatorLogFormatTest, SetPrecision) {
  ...
  test_sink.StartCapturingLogs();
  KLOG(INFO) << std::setprecision(4) << value;
}
...
TEST(ManipulatorLogFormatTest, SetPrecisionOverflow) {
  ...
  test_sink.StartCapturingLogs();
  KLOG(INFO) << std::setprecision(200) << value;
}
...
TEST(ManipulatorLogFormatTest, Left) {
  ...
  test_sink.StartCapturingLogs();
  KLOG(INFO) << std::left << std::setw(8) << value;
}
...
TEST(ManipulatorLogFormatTest, Right) {
  ...
  test_sink.StartCapturingLogs();
  KLOG(INFO) << std::right << std::setw(8) << value;
}
...
TEST(ManipulatorLogFormatTest, Internal) {
  ...
  test_sink.StartCapturingLogs();
  KLOG(INFO) << std::internal << std::setw(8) << value;
}
...
TEST(ManipulatorLogFormatTest, SetFill) {
  ...
  test_sink.StartCapturingLogs();
  KLOG(INFO) << std::setfill('0') << std::setw(8) << value;
}
...
TEST(StructuredLoggingOverflowTest, TruncatesStrings) {
  ...
  test_sink.StartCapturingLogs();
  KLOG(INFO) << std::string(2 * turbo::log_internal::kLogMessageBufferSize, 'x');
}
...
TEST(StructuredLoggingOverflowTest, TruncatesWideStrings) {
  ...
  test_sink.StartCapturingLogs();
  KLOG(INFO) << std::wstring(2 * turbo::log_internal::kLogMessageBufferSize,
                            L'x');
}
...
size_t MaxLogFieldLengthNoPrefix() {
  class StringLengthExtractorSink : public turbo::LogSink {
   public:
    void send(const turbo::LogEntry& entry) override {
      KCHECK(!size_.has_value());
      KCHECK_EQ(entry.text_message().find_first_not_of('x'),
  ...
  KLOG(INFO).no_prefix().to_sink_only(&extractor_sink)
      << std::string(2 * turbo::log_internal::kLogMessageBufferSize, 'x');
...
TEST(StructuredLoggingOverflowTest, TruncatesStringsCleanly) {
  ...
  // sizes.  To put any data in the field we need a fifth byte.
  {
    ...
    KLOG(INFO).no_prefix() << std::string(longest_fit, 'x') << "y";
  }
  {
    turbo::ScopedMockLog test_sink(turbo::MockLogDefault::kDisallowUnexpected);
    EXPECT_CALL(test_sink, send).Times(0);
    ...
    KLOG(INFO).no_prefix() << std::string(longest_fit - 1, 'x') << "y";
  }
  {
    turbo::ScopedMockLog test_sink(turbo::MockLogDefault::kDisallowUnexpected);
    EXPECT_CALL(test_sink, send).Times(0);
    ...
    KLOG(INFO).no_prefix() << std::string(longest_fit - 2, 'x') << "y";
  }
  {
    turbo::ScopedMockLog test_sink(turbo::MockLogDefault::kDisallowUnexpected);
    EXPECT_CALL(test_sink, send).Times(0);
    ...
    KLOG(INFO).no_prefix() << std::string(longest_fit - 3, 'x') << "y";
  }
  {
    turbo::ScopedMockLog test_sink(turbo::MockLogDefault::kDisallowUnexpected);
    EXPECT_CALL(test_sink, send).Times(0);
    ...
    KLOG(INFO).no_prefix() << std::string(longest_fit - 4, 'x') << "y";
  }
  {
    turbo::ScopedMockLog test_sink(turbo::MockLogDefault::kDisallowUnexpected);
    EXPECT_CALL(test_sink, send).Times(0);
    ...
    KLOG(INFO).no_prefix() << std::string(longest_fit - 5, 'x') << "y";
  }
}
...
TEST(StructuredLoggingOverflowTest, TruncatesInsertionOperatorsCleanly) {
  ...
  // sizes.  To put any data in the field we need a fifth byte.
  {
    ...
    test_sink.StartCapturingLogs();
    // x fits exactly, no part of y fits.
    KLOG(INFO).no_prefix() << std::string(longest_fit, 'x') << StringLike{"y"};
  }
  {
    turbo::ScopedMockLog test_sink(turbo::MockLogDefault::kDisallowUnexpected);
    EXPECT_CALL(test_sink, send).Times(0);
    ...
    test_sink.StartCapturingLogs();
    // x fits, one byte from y's header fits but shouldn't be visible.
    KLOG(INFO).no_prefix() << std::string(longest_fit - 1, 'x')
                         << StringLike{"y"};
  }
  {
    turbo::ScopedMockLog test_sink(turbo::MockLogDefault::kDisallowUnexpected);
    ...
    test_sink.StartCapturingLogs();
    // x fits, two bytes from y's header fit but shouldn't be visible.
    KLOG(INFO).no_prefix() << std::string(longest_fit - 2, 'x')
                         << StringLike{"y"};
  }
  {
    turbo::ScopedMockLog test_sink(turbo::MockLogDefault::kDisallowUnexpected);
    ...
    test_sink.StartCapturingLogs();
    // x fits, three bytes from y's header fit but shouldn't be visible.
    KLOG(INFO).no_prefix() << std::string(longest_fit - 3, 'x')
                         << StringLike{"y"};
  }
  {
    turbo::ScopedMockLog test_sink(turbo::MockLogDefault::kDisallowUnexpected);
    ...
    KLOG(INFO).no_prefix() << std::string(longest_fit - 4, 'x')
                         << StringLike{"y"};
  }
  {
    turbo::ScopedMockLog test_sink(turbo::MockLogDefault::kDisallowUnexpected);
    ...
    test_sink.StartCapturingLogs();
    // x fits, y fits exactly.
    KLOG(INFO).no_prefix() << std::string(longest_fit - 5, 'x')
                         << StringLike{"y"};
  }
}
