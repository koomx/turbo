...
TEST(MakeUniqueForOverwriteTest, Basic) {
  std::unique_ptr<int> p = turbo::make_unique_for_overwrite<int>();
  p = turbo::make_unique_for_overwrite<int>();
}
...
// testing turbo::make_unique_for_overwrite.
...
TEST(Initialization, MakeUniqueForOverwrite) {
  auto p = turbo::make_unique_for_overwrite<InitializationVerifier>();
...
TEST(Initialization, MakeUniqueForOverwriteArray) {
  auto p = turbo::make_unique_for_overwrite<InitializationVerifier[]>(2);
...
TEST(MakeUniqueForOverwriteTest, Array) {
  ...
  auto p = turbo::make_unique_for_overwrite<ArrayWatch[]>(5);
