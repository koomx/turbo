...
#ifndef TURBO_BASE_INTERNAL_ITERATOR_TRAITS_TEST_HELPER_H_
#define TURBO_BASE_INTERNAL_ITERATOR_TRAITS_TEST_HELPER_H_
...
struct std::iterator_traits<
    turbo::meta_internal::Cpp20ForwardZipIterator<Iterator>> {
 private:
  using IteratorReference = typename std::iterator_traits<Iterator>::reference;
