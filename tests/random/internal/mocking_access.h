...
#ifndef TURBO_RANDOM_MOCKING_ACCESS_H_
#define TURBO_RANDOM_MOCKING_ACCESS_H_
...
// the signature:
//
// bool InvokeMock(turbo::FastTypeIdType key_id, void* args_tuple, void* result)
//
...
// URBG such as turbo::MockingBitGen by calling RandomMockingAccess::InvokeMock
...
class RandomMockingAccess {
  ...
  using IdType = ::turbo::FastTypeIdType;
...
#endif  // TURBO_RANDOM_MOCKING_ACCESS_H_
