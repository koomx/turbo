...
using turbo::IntervalClosedClosedTag;
using turbo::IntervalClosedOpenTag;
using turbo::IntervalOpenClosedTag;
using turbo::IntervalOpenOpenTag;
using turbo::random_internal::uniform_inferred_return_t;
using turbo::random_internal::uniform_lower_bound;
using turbo::random_internal::uniform_upper_bound;
...
TEST_F(UniformHelperTest, UniformBoundFunctionsGeneral) {
  ...
  // turbo::uniform_int_distribution natively assumes IntervalClosedClosed
  // turbo::uniform_real_distribution natively assumes IntervalClosedOpen
