    ...
    namespace {
        ...
        struct TestStructWithCopy {
            ...
            TestStructWithCopy(TestStructWithCopy&&) {
                KLOG(FATAL) << "Move constructor should not be called";
            }
            TestStructWithCopy(const TestStructWithCopy&) {
                KLOG(FATAL) << "Copy constructor should not be called";
            }
            TestStructWithCopy& operator=(const TestStructWithCopy&) {
                KLOG(FATAL) << "Assign operator should not be called";
            }
        };
        ...
        TEST(OptionalRefTest, AsOptional) {
            ...
            std::optional<std::string_view> opt_view = ref.as_optional<std::string_view>();
