...
// LowLevelAlloc.
#ifdef TURBO_LOW_LEVEL_ALLOC_MISSING
#error TURBO_LOW_LEVEL_ALLOC_MISSING cannot be directly set
#elif !KUMO_HAVE_MMAP && !defined(_WIN32)
#define TURBO_LOW_LEVEL_ALLOC_MISSING 1
#endif
