...
namespace turbo {
    ...
    namespace base_internal {
        ...
        KUMO_CONST_INIT // Must come before __attribute__((visibility("protected")))
#if KUMO_HAVE_ATTRIBUTE(visibility) && !defined(__APPLE__)
            __attribute__((visibility("protected")))
#endif // KUMO_HAVE_ATTRIBUTE(visibility) && !defined(__APPLE__)
#if KUMO_PER_THREAD_TLS
            // Prefer __thread to thread_local as benchmarks indicate it is a bit
            // faster.
            KUMO_PER_THREAD_TLS_KEYWORD ThreadIdentity* thread_identity_ptr = nullptr;
#elif KUMO_HAVE_THREAD_LOCAL
            thread_local ThreadIdentity* thread_identity_ptr = nullptr;
#endif // KUMO_PER_THREAD_TLS
#endif // TLS or CPP11
