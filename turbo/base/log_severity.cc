...
namespace turbo {
    ...
    std::ostream& operator<<(std::ostream& os, turbo::LogSeverity s) {
        if (s == turbo::NormalizeLogSeverity(s))
            return os << turbo::LogSeverityName(s);
        return os << "turbo::LogSeverity(" << static_cast<int>(s) << ")";
    }

    std::ostream& operator<<(std::ostream& os, turbo::LogSeverityAtLeast s) {
        switch (s) {
        case turbo::LogSeverityAtLeast::kTrace:
        case turbo::LogSeverityAtLeast::kDebug:
    ...
    std::ostream& operator<<(std::ostream& os, turbo::LogSeverityAtMost s) {
        switch (s) {
        case turbo::LogSeverityAtMost::kTrace:
        case turbo::LogSeverityAtMost::kDebug:
