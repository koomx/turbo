...
//     ...
//   };
#if KUMO_HAVE_ATTRIBUTE(guarded_by)
...
#if KUMO_HAVE_ATTRIBUTE(pt_guarded_by)
...
// non-reentrant).
#if KUMO_HAVE_ATTRIBUTE(locks_excluded)
...
#if KUMO_HAVE_ATTRIBUTE(lock_returned)
...
#if KUMO_HAVE_ATTRIBUTE(lockable)
...
// constructor locked.
#if KUMO_HAVE_ATTRIBUTE(scoped_lockable)
...
#if KUMO_HAVE_ATTRIBUTE(unlock_function)
