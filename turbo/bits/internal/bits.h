...
// GCC
#define TURBO_NUMERIC_INTERNAL_HAVE_BUILTIN_OR_GCC(x) 1
#else
#define TURBO_NUMERIC_INTERNAL_HAVE_BUILTIN_OR_GCC(x) KUMO_HAVE_BUILTIN(x)
#endif

#if TURBO_NUMERIC_INTERNAL_HAVE_BUILTIN_OR_GCC(__builtin_popcountl) && \
TURBO_NUMERIC_INTERNAL_HAVE_BUILTIN_OR_GCC(__builtin_popcountll)
#define TURBO_INTERNAL_CONSTEXPR_POPCOUNT constexpr
#define TURBO_INTERNAL_HAS_CONSTEXPR_POPCOUNT 1
#else
#define TURBO_INTERNAL_CONSTEXPR_POPCOUNT
#define TURBO_INTERNAL_HAS_CONSTEXPR_POPCOUNT 0
#endif

#if TURBO_NUMERIC_INTERNAL_HAVE_BUILTIN_OR_GCC(__builtin_clz) && \
TURBO_NUMERIC_INTERNAL_HAVE_BUILTIN_OR_GCC(__builtin_clzll)
#define TURBO_INTERNAL_CONSTEXPR_CLZ constexpr
#define TURBO_INTERNAL_HAS_CONSTEXPR_CLZ 1
#else
#define TURBO_INTERNAL_CONSTEXPR_CLZ
#define TURBO_INTERNAL_HAS_CONSTEXPR_CLZ 0
#endif

#if TURBO_NUMERIC_INTERNAL_HAVE_BUILTIN_OR_GCC(__builtin_ctz) && \
TURBO_NUMERIC_INTERNAL_HAVE_BUILTIN_OR_GCC(__builtin_ctzll)
#define TURBO_INTERNAL_CONSTEXPR_CTZ constexpr
#define TURBO_INTERNAL_HAS_CONSTEXPR_CTZ 1
#else
#define TURBO_INTERNAL_CONSTEXPR_CTZ
#define TURBO_INTERNAL_HAS_CONSTEXPR_CTZ 0
#endif
...
namespace turbo {
    namespace bits_internal {
        ...
        template<class T>
        [[nodiscard]] KUMO_ATTRIBUTE_ALWAYS_INLINE constexpr T RotateRight(
            T x, int s) noexcept {
        ...
        template<class T>
        [[nodiscard]] KUMO_ATTRIBUTE_ALWAYS_INLINE constexpr T RotateLeft(
            T x, int s) noexcept {
            static_assert(std::is_unsigned_v<T>, "T must be unsigned");
            static_assert(IsPowerOf2(std::numeric_limits<T>::digits),
                          "T must have a power-of-2 size");
        ...
        KUMO_ATTRIBUTE_ALWAYS_INLINE TURBO_INTERNAL_CONSTEXPR_POPCOUNT inline int
        ...
        KUMO_ATTRIBUTE_ALWAYS_INLINE TURBO_INTERNAL_CONSTEXPR_CLZ inline int
...
#elif KUMO_HAVE_BUILTIN(__builtin_clzs)
    ...
    (defined(_M_X64) || defined(_M_ARM64))
        ...
        KUMO_ATTRIBUTE_ALWAYS_INLINE TURBO_INTERNAL_CONSTEXPR_CTZ inline int
...
#elif KUMO_HAVE_BUILTIN(__builtin_ctzs)
            static_assert(sizeof(unsigned short) == sizeof(x), // NOLINT(runtime/int)
