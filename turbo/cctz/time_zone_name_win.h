...
#ifndef TURBO_TIME_INTERNAL_CCTZ_TIME_ZONE_NAME_WIN_H_
#define TURBO_TIME_INTERNAL_CCTZ_TIME_ZONE_NAME_WIN_H_
...
#endif  // TURBO_TIME_INTERNAL_CCTZ_TIME_ZONE_NAME_WIN_H_
