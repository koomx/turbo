...
struct ConfigItem {
    ...
    XCLI_NODISCARD std::string fullname() const {
...
class Config {
  ...
  public:
    ...
    /// Get a flag value
    XCLI_NODISCARD virtual std::string to_flag(const ConfigItem &item) const {
    ...
    XCLI_NODISCARD std::vector<ConfigItem> from_file(const std::string &name) const {
...
class ConfigBase : public Config {
  ...
  public:
    ...
    /// get the section
    XCLI_NODISCARD const std::string &section() const { return configSection; }
    ...
    XCLI_NODISCARD int16_t index() const { return configIndex; }
