...
/// about the structure in xcli::Formatter.
class FormatterBase {
  protected:
    /// @name Options
    ///@{
  ...
  public:
    ...
    XCLI_NODISCARD std::string get_label(std::string key) const {
    ...
    XCLI_NODISCARD std::size_t get_column_width() const { return column_width_; }

    /// Get the current right column width (description of options/flags/subcommands)
    XCLI_NODISCARD std::size_t get_right_column_width() const { return right_column_width_; }

    /// Get the current description paragraph width at the top of help
    XCLI_NODISCARD std::size_t get_description_paragraph_width() const { return description_paragraph_width_; }

    /// Get the current footer paragraph width
    XCLI_NODISCARD std::size_t get_footer_paragraph_width() const { return footer_paragraph_width_; }
    ...
    XCLI_NODISCARD float get_long_option_alignment_ratio() const { return long_option_alignment_ratio_; }

    /// Get the current status of description paragraph formatting
    XCLI_NODISCARD bool is_description_paragraph_formatting_enabled() const { return enable_description_formatting_; }

    /// Get the current status of whether footer paragraph formatting is enabled
    XCLI_NODISCARD bool is_footer_paragraph_formatting_enabled() const { return enable_footer_formatting_; }

    /// Get the current status of whether option defaults are printed
    XCLI_NODISCARD bool is_option_defaults_enabled() const { return enable_option_defaults_; }

    /// Get the current status of whether option type names are printed
    XCLI_NODISCARD bool is_option_type_names_enabled() const { return enable_option_type_names_; }

    /// Get the current status of whether default flag values are printed
    XCLI_NODISCARD bool is_default_flag_values_enabled() const { return enable_default_flag_values_; }
...
class Formatter : public FormatterBase {
  public:
    ...
    ///
    XCLI_NODISCARD virtual std::string
