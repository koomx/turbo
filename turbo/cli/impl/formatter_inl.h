...
namespace detail {
XCLI_INLINE std::string indent_block(const std::string &input, const std::string &indent) {
...
XCLI_INLINE std::string Formatter::make_positionals(const App *app) const {
...
XCLI_INLINE std::string Formatter::make_groups(const App *app, AppFormatMode mode) const {
    std::stringstream out;
...
XCLI_INLINE std::string Formatter::make_description(const App *app) const {
...
XCLI_INLINE std::string Formatter::make_usage(const App *app, std::string name) const {
    ...
    if(!app->get_subcommands(
               [](const xcli::App *subc) { return ((!subc->get_disabled()) && (!subc->get_name().empty())); })
            .empty()) {
...
XCLI_INLINE std::string Formatter::make_footer(const App *app) const {
...
XCLI_INLINE std::string Formatter::make_help(const App *app, std::string name, AppFormatMode mode) const {
...
XCLI_INLINE std::string Formatter::make_subcommands(const App *app, AppFormatMode mode) const {
    std::stringstream out;
...
XCLI_INLINE std::string Formatter::make_subcommand(const App *sub) const {
    std::stringstream out;
...
XCLI_INLINE std::string Formatter::make_expanded(const App *sub, AppFormatMode mode) const {
    std::stringstream out;
...
XCLI_INLINE std::string Formatter::make_option(const Option *opt, bool is_positional) const {
    std::stringstream out;
    if(is_positional) {
...
XCLI_INLINE std::string Formatter::make_option_name(const Option *opt, bool is_positional) const {
    if(is_positional)
...
XCLI_INLINE std::string Formatter::make_option_opts(const Option *opt) const {
    std::stringstream out;
...
XCLI_INLINE std::string Formatter::make_option_desc(const Option *opt) const { return opt->get_description(); }

XCLI_INLINE std::string Formatter::make_option_usage(const Option *opt) const {
