...
namespace xcli {
    ...
    namespace detail {
        ...
        static std::size_t close_string_quote(const std::string& str, std::size_t start, char closure_char) {
            std::size_t loc { 0 };
        ...
        static std::size_t close_literal_quote(const std::string& str, std::size_t start, char closure_char) {
        ...
        std::string binary_escape_string(const std::string& string_to_escape, bool force) {
        ...
        bool process_quoted_string(std::string& str, char string_char, char literal_char, bool disable_secondary_array_processing) {
            if (str.size() <= 1) {
                return false;
            }
        ...
        std::ostream& stream_out_as_paragraph(std::ostream& out,
