...
#ifndef TURBO_CONTAINER_BTREE_MAP_H_
#define TURBO_CONTAINER_BTREE_MAP_H_
...
// turbo::btree_map<>
//
// An `turbo::btree_map<K, V>` is an ordered associative container of
...
// `std::less<K>`.
//
// An `turbo::btree_map<K, V>` uses a default allocator of
// `std::allocator<std::pair<const K, V>>` to allocate (and deallocate)
// nodes, and construct and destruct values within those nodes. You may
// instead specify a custom allocator `A` (which in turn requires specifying a
// custom comparator `C`) as in `turbo::btree_map<K, V, C, A>`.
//
template <typename Key, typename Value, typename Compare = std::less<Key>,
          typename Alloc = std::allocator<std::pair<const Key, Value>>>
class KUMO_ATTRIBUTE_OWNER btree_map
 ...
 public:
  ...
  // * Default constructor
  //
  //   turbo::btree_map<int, std::string> map1;
  //
  // * Initializer List constructor
  //
  //   turbo::btree_map<int, std::string> map2 =
  //       {{1, "huey"}, {2, "dewey"}, {3, "louie"},};
  //
  // * Copy constructor
  //
  //   turbo::btree_map<int, std::string> map3(map2);
  //
  // * Copy assignment operator
  //
  //   turbo::btree_map<int, std::string> map4;
  //   map4 = map3;
  //
  // * Move constructor
  //
  //   // Move is guaranteed efficient
  //   turbo::btree_map<int, std::string> map5(std::move(map4));
  //
  // * Move assignment operator
  //
  //   // May be efficient if allocators are compatible
  //   turbo::btree_map<int, std::string> map6;
  //   map6 = std::move(map5);
  //
  // * Range constructor
  //
  //   std::vector<std::pair<int, std::string>> v = {{1, "a"}, {2, "b"}};
  //   turbo::btree_map<int, std::string> map7(v.begin(), v.end());
  btree_map() {}
  using Base::Base;
...
// turbo::swap(turbo::btree_map<>, turbo::btree_map<>)
//
// Swaps the contents of two `turbo::btree_map` containers.
template <typename K, typename V, typename C, typename A>
void swap(btree_map<K, V, C, A> &x, btree_map<K, V, C, A> &y) {
  return x.swap(y);
}

// turbo::erase_if(turbo::btree_map<>, Pred)
//
...
// turbo::btree_multimap
//
// An `turbo::btree_multimap<K, V>` is an ordered associative container of
// keys and associated values designed to be a more efficient replacement for
// `std::multimap` (in most cases). Unlike `turbo::btree_map`, a B-tree multimap
// allows multiple elements with equivalent keys.
//
// Keys are sorted using an (optional) comparison function, which defaults to
// `std::less<K>`.
//
// An `turbo::btree_multimap<K, V>` uses a default allocator of
// `std::allocator<std::pair<const K, V>>` to allocate (and deallocate)
// nodes, and construct and destruct values within those nodes. You may
// instead specify a custom allocator `A` (which in turn requires specifying a
// custom comparator `C`) as in `turbo::btree_multimap<K, V, C, A>`.
//
template <typename Key, typename Value, typename Compare = std::less<Key>,
          typename Alloc = std::allocator<std::pair<const Key, Value>>>
class KUMO_ATTRIBUTE_OWNER btree_multimap
 ...
 public:
  ...
  // * Default constructor
  //
  //   turbo::btree_multimap<int, std::string> map1;
  //
  // * Initializer List constructor
  //
  //   turbo::btree_multimap<int, std::string> map2 =
  //       {{1, "huey"}, {2, "dewey"}, {3, "louie"},};
  //
  // * Copy constructor
  //
  //   turbo::btree_multimap<int, std::string> map3(map2);
  //
  // * Copy assignment operator
  //
  //   turbo::btree_multimap<int, std::string> map4;
  //   map4 = map3;
  //
  // * Move constructor
  //
  //   // Move is guaranteed efficient
  //   turbo::btree_multimap<int, std::string> map5(std::move(map4));
  //
  // * Move assignment operator
  //
  //   // May be efficient if allocators are compatible
  //   turbo::btree_multimap<int, std::string> map6;
  //   map6 = std::move(map5);
  //
  // * Range constructor
  //
  //   std::vector<std::pair<int, std::string>> v = {{1, "a"}, {2, "b"}};
  //   turbo::btree_multimap<int, std::string> map7(v.begin(), v.end());
  btree_multimap() {}
  using Base::Base;
...
// turbo::swap(turbo::btree_multimap<>, turbo::btree_multimap<>)
//
// Swaps the contents of two `turbo::btree_multimap` containers.
template <typename K, typename V, typename C, typename A>
void swap(btree_multimap<K, V, C, A> &x, btree_multimap<K, V, C, A> &y) {
  return x.swap(y);
}

// turbo::erase_if(turbo::btree_multimap<>, Pred)
//
// Erases all elements that satisfy the predicate pred from the container.
// Returns the number of erased elements.
template <typename K, typename V, typename C, typename A, typename Pred>
...
struct map_params_impl
  ...
  template <typename V>
  static auto key(const V &value KUMO_ATTRIBUTE_LIFETIME_BOUND)
...
#endif  // TURBO_CONTAINER_BTREE_MAP_H_
