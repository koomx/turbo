...
// turbo::btree_set<>
//
// An `turbo::btree_set<K>` is an ordered associative container of unique key
...
// `std::less<K>`.
//
// An `turbo::btree_set<K>` uses a default allocator of `std::allocator<K>` to
...
// `turbo::btree_set<K, C, A>`.
//
template <typename Key, typename Compare = std::less<Key>,
          typename Alloc = std::allocator<Key>>
class KUMO_ATTRIBUTE_OWNER btree_set
 ...
 public:
  ...
  // * Default constructor
  //
  //   turbo::btree_set<std::string> set1;
  //
  // * Initializer List constructor
  //
  //   turbo::btree_set<std::string> set2 =
  //       {{"huey"}, {"dewey"}, {"louie"},};
  //
  // * Copy constructor
  //
  //   turbo::btree_set<std::string> set3(set2);
  //
  // * Copy assignment operator
  //
  //   turbo::btree_set<std::string> set4;
  //   set4 = set3;
  //
  // * Move constructor
  //
  //   // Move is guaranteed efficient
  //   turbo::btree_set<std::string> set5(std::move(set4));
  //
  // * Move assignment operator
  //
  //   // May be efficient if allocators are compatible
  //   turbo::btree_set<std::string> set6;
  //   set6 = std::move(set5);
  //
  // * Range constructor
  //
  //   std::vector<std::string> v = {"a", "b"};
  //   turbo::btree_set<std::string> set7(v.begin(), v.end());
  btree_set() {}
  using Base::Base;
...
// turbo::swap(turbo::btree_set<>, turbo::btree_set<>)
//
// Swaps the contents of two `turbo::btree_set` containers.
template <typename K, typename C, typename A>
void swap(btree_set<K, C, A> &x, btree_set<K, C, A> &y) {
  return x.swap(y);
}

// turbo::erase_if(turbo::btree_set<>, Pred)
//
...
// turbo::btree_multiset<>
//
// An `turbo::btree_multiset<K>` is an ordered associative container of
// keys and associated values designed to be a more efficient replacement
// for `std::multiset` (in most cases). Unlike `turbo::btree_set`, a B-tree
// multiset allows equivalent elements.
//
// Keys are sorted using an (optional) comparison function, which defaults to
// `std::less<K>`.
//
// An `turbo::btree_multiset<K>` uses a default allocator of `std::allocator<K>`
// to allocate (and deallocate) nodes, and construct and destruct values within
// those nodes. You may instead specify a custom allocator `A` (which in turn
// requires specifying a custom comparator `C`) as in
// `turbo::btree_multiset<K, C, A>`.
//
template <typename Key, typename Compare = std::less<Key>,
          typename Alloc = std::allocator<Key>>
class KUMO_ATTRIBUTE_OWNER btree_multiset
 ...
 public:
  ...
  // * Default constructor
  //
  //   turbo::btree_multiset<std::string> set1;
  //
  // * Initializer List constructor
  //
  //   turbo::btree_multiset<std::string> set2 =
  //       {{"huey"}, {"dewey"}, {"louie"},};
  //
  // * Copy constructor
  //
  //   turbo::btree_multiset<std::string> set3(set2);
  //
  // * Copy assignment operator
  //
  //   turbo::btree_multiset<std::string> set4;
  //   set4 = set3;
  //
  // * Move constructor
  //
  //   // Move is guaranteed efficient
  //   turbo::btree_multiset<std::string> set5(std::move(set4));
  //
  // * Move assignment operator
  //
  //   // May be efficient if allocators are compatible
  //   turbo::btree_multiset<std::string> set6;
  //   set6 = std::move(set5);
  //
  // * Range constructor
  //
  //   std::vector<std::string> v = {"a", "b"};
  //   turbo::btree_multiset<std::string> set7(v.begin(), v.end());
  btree_multiset() {}
  using Base::Base;
...
// turbo::swap(turbo::btree_multiset<>, turbo::btree_multiset<>)
//
// Swaps the contents of two `turbo::btree_multiset` containers.
template <typename K, typename C, typename A>
void swap(btree_multiset<K, C, A> &x, btree_multiset<K, C, A> &y) {
  return x.swap(y);
}

// turbo::erase_if(turbo::btree_multiset<>, Pred)
//
// Erases all elements that satisfy the predicate pred from the container.
// Returns the number of erased elements.
template <typename K, typename C, typename A, typename Pred>
