...
#define TURBO_INTERNAL_SINGLE_ARG(...) __VA_ARGS__

#define TURBO_INTERNAL_IF_true(if_satisfied, ...) if_satisfied
#define TURBO_INTERNAL_IF_false(if_satisfied, ...) __VA_ARGS__

#define TURBO_INTERNAL_IF_true_AND_true TURBO_INTERNAL_IF_true
#define TURBO_INTERNAL_IF_false_AND_false TURBO_INTERNAL_IF_false
#define TURBO_INTERNAL_IF_true_AND_false TURBO_INTERNAL_IF_false_AND_false
#define TURBO_INTERNAL_IF_false_AND_true TURBO_INTERNAL_IF_false_AND_false

#define TURBO_INTERNAL_IF_true_OR_true TURBO_INTERNAL_IF_true
#define TURBO_INTERNAL_IF_false_OR_false TURBO_INTERNAL_IF_false
#define TURBO_INTERNAL_IF_true_OR_false TURBO_INTERNAL_IF_true_OR_true
#define TURBO_INTERNAL_IF_false_OR_true TURBO_INTERNAL_IF_true_OR_true

#define TURBO_INTERNAL_IF_true_NOR_true TURBO_INTERNAL_IF_false_AND_false
#define TURBO_INTERNAL_IF_false_NOR_false TURBO_INTERNAL_IF_true_AND_true
#define TURBO_INTERNAL_IF_true_NOR_false TURBO_INTERNAL_IF_false_AND_true
#define TURBO_INTERNAL_IF_false_NOR_true TURBO_INTERNAL_IF_true_AND_false

#define TURBO_INTERNAL_COMMA ,
...
// deduplicate them with turbo::functional_internal::EnableIf.
template <class Cond>
