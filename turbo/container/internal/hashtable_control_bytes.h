...
#ifndef TURBO_CONTAINER_INTERNAL_HASHTABLE_CONTROL_BYTES_H_
#define TURBO_CONTAINER_INTERNAL_HASHTABLE_CONTROL_BYTES_H_
 ...
 public:
  explicit BitMask(T mask) : Base(mask) {
    if (Shift == 3 && !NullifyBitsOnIteration) {
      TURBO_SWISSTABLE_ASSERT(this->mask_ == (this->mask_ & kMsbs8Bytes));
    }
  }
...
#if KUMO_SIMD_NEON && KUMO_ENDIAN_LITTLE
...
#endif  // KUMO_SIMD_NEON && KUMO_ENDIAN_LITTLE
...
#elif KUMO_SIMD_NEON && KUMO_ENDIAN_LITTLE
...
#endif  // TURBO_CONTAINER_INTERNAL_HASHTABLE_CONTROL_BYTES_H_
