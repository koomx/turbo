...
#define TURBO_INTERNAL_X(Func, Callee, KQual, VQual, KValue, VValue, Tail, ...) \
  template <                                                                   \
      typename K = key_type, class V = mapped_type,                            \
      TURBO_INTERNAL_IF_##KValue##_NOR_##VValue(                                \
  ...
  decltype(auto) Func(                                                         \
      ...
      V VQual v TURBO_INTERNAL_IF_##VValue(                                     \
          KUMO_INTERNAL_ATTRIBUTE_CAPTURED_BY_THIS))                           \
      KUMO_ATTRIBUTE_LIFETIME_BOUND {                                          \
    return TURBO_INTERNAL_IF_##KValue##_OR_##VValue(                            \
  ...
  TURBO_INTERNAL_X(insert_or_assign, insert_or_assign_impl, const&, const&,
                  false, false, TURBO_INTERNAL_SINGLE_ARG());
  TURBO_INTERNAL_X(insert_or_assign, insert_or_assign_impl, const&, const&,
                  false, true, TURBO_INTERNAL_SINGLE_ARG());
  TURBO_INTERNAL_X(insert_or_assign, insert_or_assign_impl, const&, const&, true,
                  false, TURBO_INTERNAL_SINGLE_ARG());
  TURBO_INTERNAL_X(insert_or_assign, insert_or_assign_impl, const&, const&, true,
                  true, TURBO_INTERNAL_SINGLE_ARG());
  ...
  TURBO_INTERNAL_X(insert_or_assign, insert_or_assign_impl, &&, &&, false, false,
                  TURBO_INTERNAL_SINGLE_ARG());
  ...
  TURBO_INTERNAL_X(insert_or_assign, insert_or_assign_impl, const&, const&,
                  false, false, .first, const_iterator TURBO_INTERNAL_COMMA);
  TURBO_INTERNAL_X(insert_or_assign, insert_or_assign_impl, const&, const&,
                  false, true, .first, const_iterator TURBO_INTERNAL_COMMA);
  TURBO_INTERNAL_X(insert_or_assign, insert_or_assign_impl, const&, const&, true,
                  false, .first, const_iterator TURBO_INTERNAL_COMMA);
  TURBO_INTERNAL_X(insert_or_assign, insert_or_assign_impl, const&, const&, true,
                  true, .first, const_iterator TURBO_INTERNAL_COMMA);
  ...
  TURBO_INTERNAL_X(insert_or_assign, insert_or_assign_impl, &&, &&, false, false,
                  .first, const_iterator TURBO_INTERNAL_COMMA);
  TURBO_INTERNAL_X(insert_or_assign, insert_or_assign_impl, &&, &&, false, true,
                  .first, const_iterator TURBO_INTERNAL_COMMA);
  TURBO_INTERNAL_X(insert_or_assign, insert_or_assign_impl, &&, &&, true, false,
                  .first, const_iterator TURBO_INTERNAL_COMMA);
...
#undef TURBO_INTERNAL_X
  ...
  MappedReference<P> at(const key_arg<K>& key) KUMO_ATTRIBUTE_LIFETIME_BOUND {
    ...
    if (it == this->end()) {
      ThrowStdOutOfRange("turbo::container_internal::raw_hash_map<>::at");
    }
  ...
  MappedReference<P> operator[](
      key_arg<K>&& key KUMO_INTERNAL_ATTRIBUTE_CAPTURED_BY_THIS)
      KUMO_ATTRIBUTE_LIFETIME_BOUND {
  ...
  template <class K = key_type, class P = Policy, int&...,
            EnableIf<LifetimeBoundK<K, true>> = 0>
  MappedReference<P> operator[](
      const key_arg<K>& key KUMO_INTERNAL_ATTRIBUTE_CAPTURED_BY_THIS)
      KUMO_ATTRIBUTE_LIFETIME_BOUND {
