...
#ifndef TURBO_CONTAINER_LINKED_HASH_SET_H_
#define TURBO_CONTAINER_LINKED_HASH_SET_H_
...
template <
    typename Key, typename KeyHash = typename turbo::flat_hash_set<Key>::hasher,
    typename KeyEq = typename turbo::flat_hash_set<Key, KeyHash>::key_equal,
...
#endif  // TURBO_CONTAINER_LINKED_HASH_SET_H_
