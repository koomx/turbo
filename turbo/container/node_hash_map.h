...
// -----------------------------------------------------------------------------
//
// An `turbo::node_hash_map<K, V>` is an unordered associative container of
...
// -----------------------------------------------------------------------------
//
// An `turbo::node_hash_map<K, V>` is an unordered associative container which
...
//   turbo::node_hash_map<std::string, std::string> ducks =
...
class KUMO_ATTRIBUTE_OWNER node_hash_map
    : public turbo::container_internal::InstantiateRawHashMap<
          turbo::container_internal::NodeHashMapPolicy<Key, Value>, Hash, Eq,
          Alloc>::type {
 ...
 public:
  ...
  //    turbo::node_hash_map<int, std::string> map1;
  //
  // * Initializer List constructor
  //
  //   turbo::node_hash_map<int, std::string> map2 =
  //       {{1, "huey"}, {2, "dewey"}, {3, "louie"},};
  //
  // * Copy constructor
  //
  //   turbo::node_hash_map<int, std::string> map3(map2);
  //
  // * Copy assignment operator
  //
  //   // Hash functor and Comparator are copied as well
  //   turbo::node_hash_map<int, std::string> map4;
  //   map4 = map3;
  //
  // * Move constructor
  //
  //   // Move is guaranteed efficient
  //   turbo::node_hash_map<int, std::string> map5(std::move(map4));
  //
  ...
  //   turbo::node_hash_map<int, std::string> map6;
  //   map6 = std::move(map5);
  //
  ...
  //   turbo::node_hash_map<int, std::string> map7(v.begin(), v.end());
  //
  // * from_range constructor (C++23)
  //
  //   std::vector<std::pair<int, std::string>> v = {{1, "a"}, {2, "b"}};
  //   turbo::node_hash_map<int, std::string> map8(std::from_range, v);
  node_hash_map() {}
  using Base::Base;
  ...
  //
  // NOTE: this member function is particular to `turbo::node_hash_map` and is
...
template <class Key, class Value>
class NodeHashMapPolicy
    : public turbo::container_internal::node_slot_policy<
...
struct IsUnorderedContainer<
    turbo::node_hash_map<Key, T, Hash, KeyEqual, Allocator>> : std::true_type {};
