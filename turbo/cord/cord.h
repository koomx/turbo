...
[[nodiscard]] size_t CopyCordToSpan(const Cord& src, turbo::Span<char> dst);
...
class Cord {
 ...
 public:
  ...
  friend void CopyCordToString(const Cord& src, std::string* turbo_nonnull dst);
  ...
  friend size_t CopyCordToSpan(const Cord& src, turbo::Span<char> dst);
  ...
  class ChunkIterator {
   ...
   private:
    ...
    void InitTree(cord_internal::CordRep* turbo_nonnull tree);
  ...
  class ChunkRange {
   public:
    ...
    explicit ChunkRange(const Cord* turbo_nonnull cord) : cord_(cord) {}
  ...
  static Cord AdvanceAndRead(CharIterator* turbo_nonnull it, size_t n_bytes);
  ...
  class CharRange {
   public:
    ...
    explicit CharRange(const Cord* turbo_nonnull cord) : cord_(cord) {}
  ...
  friend void TurboFormatFlush(turbo::Cord* turbo_nonnull cord,
 ...
 private:
  ...
  class InlineRep {
   public:
    ...
    void AppendArray(std::string_view src);
  ...
  static bool GetFlatAux(turbo::cord_internal::CordRep* turbo_nonnull rep,
  ...
  void CopyToArrayImpl(char* turbo_nonnull dst) const;
};
...
inline void Cord::Append(CordBuffer buffer) {
  if (KUMO_UNLIKELY(buffer.length() == 0)) return;
...
inline void Cord::CopyToArrayImpl(char* turbo_nonnull dst) const {
...
inline Cord Cord::AdvanceAndRead(CharIterator* turbo_nonnull it,
                                 size_t n_bytes) {
  assert(it != nullptr);
