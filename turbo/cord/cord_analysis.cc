...
struct CordRepRef {
  ...
  explicit CordRepRef(const CordRep* turbo_nonnull r) : rep(r) {}
...
size_t GetEstimatedMemoryUsage(const CordRep* turbo_nonnull rep) {
  return GetEstimatedUsage<Mode::kTotal>(rep);
}

size_t GetEstimatedFairShareMemoryUsage(const CordRep* turbo_nonnull rep) {
  return GetEstimatedUsage<Mode::kFairShare>(rep);
}

size_t GetMorePreciseMemoryUsage(const CordRep* turbo_nonnull rep) {
