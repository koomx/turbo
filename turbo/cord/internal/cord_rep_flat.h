...
#ifndef TURBO_STRINGS_INTERNAL_CORD_REP_FLAT_H_
#define TURBO_STRINGS_INTERNAL_CORD_REP_FLAT_H_
...
struct CordRepFlat : public CordRep {
  ...
  static CordRepFlat* NewImpl(size_t len, Args... args KUMO_ATTRIBUTE_UNUSED) {
    ...
    #if KUMO_INTERNAL_HAVE_MIN_GNUC_VERSION(13, 0)
  ...
  static CordRepFlat* Create(std::string_view data, size_t extra = 0) {
...
#endif  // TURBO_STRINGS_INTERNAL_CORD_REP_FLAT_H_
