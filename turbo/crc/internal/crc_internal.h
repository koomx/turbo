...
namespace turbo {
    ...
    namespace crc_internal {
        ...
        constexpr int kPrefetchHorizon = KUMO_CACHELINE_SIZE * 4; // Prefetch this far
        // Shorter prefetch distance for smaller buffers
        constexpr int kPrefetchHorizonMedium = KUMO_CACHELINE_SIZE * 1;
        ...
        constexpr uint64_t kScrambleHi = (static_cast<uint64_t>(0x4f1bbcdcU) << 32) | static_cast<uint64_t>(0xbfa53e0aU);
        constexpr uint64_t kScrambleLo = (static_cast<uint64_t>(0xf9ce6030U) << 32) | static_cast<uint64_t>(0x2e76e41bU);
