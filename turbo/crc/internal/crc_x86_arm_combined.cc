...
using ::turbo::base_internal::CpuType;
using ::turbo::base_internal::GetCpuType;
using ::turbo::base_internal::SupportsArmCRC32PMULL;
...
#if defined(TURBO_CRC_INTERNAL_HAVE_X86_SIMD) && defined(__AVX__) && \
