...
#ifndef TURBO_DEBUGGING_INTERNAL_ADDRESSES_H_
#define TURBO_DEBUGGING_INTERNAL_ADDRESSES_H_
...
#define TURBO_XPACLRI_HINT "hint #0x7;"
  asm(TURBO_XPACLRI_HINT : "+r"(x30));  // asm("xpaclri" : "+r"(x30));
#undef TURBO_XPACLRI_HINT
  return x30;
#else
  return ptr;
#endif
...
#endif  // TURBO_DEBUGGING_INTERNAL_ADDRESSES_H_
