...
#ifndef TURBO_DEBUGGING_INTERNAL_DECODE_RUST_PUNYCODE_H_
#define TURBO_DEBUGGING_INTERNAL_DECODE_RUST_PUNYCODE_H_
...
struct DecodeRustPunycodeOptions {
  const char* turbo_nonnull punycode_begin;
  const char* turbo_nonnull punycode_end;
  char* turbo_nonnull out_begin;
  char* turbo_nonnull out_end;
};
...
#endif  // TURBO_DEBUGGING_INTERNAL_DECODE_RUST_PUNYCODE_H_
