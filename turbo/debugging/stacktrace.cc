...
KUMO_ATTRIBUTE_NOINLINE KUMO_ATTRIBUTE_NO_TAIL_CALL int GetStackFrames(
...
KUMO_ATTRIBUTE_NOINLINE KUMO_ATTRIBUTE_NO_TAIL_CALL int
...
KUMO_ATTRIBUTE_NOINLINE KUMO_ATTRIBUTE_NO_TAIL_CALL int GetStackTrace(
...
KUMO_ATTRIBUTE_WEAK bool internal_stacktrace::ShouldFixUpStack() {
  return false;
}
...
KUMO_ATTRIBUTE_WEAK void internal_stacktrace::FixUpStack(void**, uintptr_t*,
                                                         int*, size_t,
                                                         size_t&) {}
