...
//
// To obtain an turbo::CommandLineFlag, invoke `turbo::FindCommandLineFlag()`
...
//        turbo::FindCommandLineFlag("flagname");
//
...
#pragma GCC diagnostic ignored "-Wnon-virtual-dtor"
  ...
  // turbo::CommandLineFlag::has_user_validator()
  //
  // Returns true if a user validator was registered via on_validate().
  virtual bool has_user_validator() const { return false; }
  ...
  bool ParseFrom(std::string_view value, std::string* turbo_nonnull error);
    ...
    private:
        ...
        virtual void Read(void* turbo_nonnull dst) const = 0;
        ...
        // turbo::CommandLineFlag::TypeName()
        //
        // Returns string representation of the type of this flag
        // (the way it is spelled in the TURBO_FLAG macro).
