...
namespace {
KUMO_CONST_INIT std::mutex usage_message_guard;
KUMO_CONST_INIT std::string* program_usage_message
...
void SetProgramUsageMessage(std::string_view new_usage_message) {
  std::lock_guard<std::mutex> l(flags_internal::usage_message_guard);
