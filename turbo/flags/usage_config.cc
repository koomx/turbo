...
KUMO_CONST_INIT FlagsUsageConfig* custom_usage_config
    TURBO_GUARDED_BY(CustomUsageConfigMutex())
        TURBO_PT_GUARDED_BY(CustomUsageConfigMutex()) = nullptr;
...
void SetFlagsUsageConfig(FlagsUsageConfig usage_config) {
  std::lock_guard<std::mutex> l(flags_internal::CustomUsageConfigMutex());
