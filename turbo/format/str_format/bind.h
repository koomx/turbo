...
namespace turbo {
    ...
    namespace str_format_internal {
        ...
        public:
            ...
            __attribute__ ((unavailable("str_printf_to string is not constexpr.")));
            ...
            unavailable (
              "str_printf_to specified does not match the arguments passed.")));
            ...
            FormatSpecTemplate(std::string_view s) : Base(s) {
            } // NOLINT
        ...
        bool str_printf_untyped_to(FormatRawSinkImpl raw_sink, UntypedFormatSpecImpl format,
                           turbo::Span<const FormatArgImpl> args);
