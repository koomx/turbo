    ...
    namespace str_format_internal {
        ...
        bool ParseFormatString(std::string_view src, Consumer consumer) {
            ...
            while (p != end) {
                ...
                if (KUMO_UNLIKELY(percent + 1 >= end)) return false;
                ...
                if (tag.is_conv()) {
                    ...
                    if (KUMO_UNLIKELY(p == nullptr)) return false;
                    if (KUMO_UNLIKELY(!consumer.ConvertOne(
                        conv, std::string_view(percent + 1,
        ...
        public:
            ...
            bool ProcessFormat(Consumer consumer) const {
                ...
                for (const auto &item: items_) {
                    ...
                    text =
                            std::string_view(end, static_cast<size_t>((base + item.text_end) - end));
