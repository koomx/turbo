...
uint32_t CityHash32(const char *s, size_t len) {
  ...
  uint32_t a0 = turbo::rotr(Fetch32(s + len - 4) * c1, 17) * c2;
  uint32_t a1 = turbo::rotr(Fetch32(s + len - 8) * c1, 17) * c2;
  uint32_t a2 = turbo::rotr(Fetch32(s + len - 16) * c1, 17) * c2;
  uint32_t a3 = turbo::rotr(Fetch32(s + len - 12) * c1, 17) * c2;
  uint32_t a4 = turbo::rotr(Fetch32(s + len - 20) * c1, 17) * c2;
  h ^= a0;
  h = turbo::rotr(h, 19);
  h = h * 5 + 0xe6546b64;
  h ^= a2;
  ...
  do {
    uint32_t b0 = turbo::rotr(Fetch32(s) * c1, 17) * c2;
    uint32_t b1 = Fetch32(s + 4);
    uint32_t b2 = turbo::rotr(Fetch32(s + 8) * c1, 17) * c2;
    uint32_t b3 = turbo::rotr(Fetch32(s + 12) * c1, 17) * c2;
  ...
  g = turbo::rotr(g, 11) * c1;
  g = turbo::rotr(g, 17) * c1;
  f = turbo::rotr(f, 11) * c1;
  f = turbo::rotr(f, 17) * c1;
  h = turbo::rotr(h + g, 19);
  h = h * 5 + 0xe6546b64;
  h = turbo::rotr(h, 17) * c1;
  h = turbo::rotr(h + f, 19);
  h = h * 5 + 0xe6546b64;
  h = turbo::rotr(h, 17) * c1;
  return h;
...
static uint64_t HashLen0to16(const char *s, size_t len) {
  if (len >= 8) {
    ...
    uint64_t c = turbo::rotr(b, 37) * mul + a;
    uint64_t d = (turbo::rotr(a, 25) + b) * mul;
...
static uint64_t HashLen17to32(const char *s, size_t len) {
  ...
  return HashLen16(turbo::rotr(a + b, 43) + turbo::rotr(c, 30) + d,
                   a + turbo::rotr(b + k2, 18) + c, mul);
}
...
static uint64_t HashLen33to64(const char *s, size_t len) {
  ...
  uint64_t u = turbo::rotr(a + g, 43) + (turbo::rotr(b, 30) + c) * 9;
  uint64_t v = ((a + g) ^ d) + f + 1;
  uint64_t w = turbo::gbswap_64((u + v) * mul) + h;
  uint64_t x = turbo::rotr(e + f, 42) + c;
...
uint64_t CityHash64(const char *s, size_t len) {
  ...
  do {
    x = turbo::rotr(x + y + v.first + Fetch64(s + 8), 37) * k1;
    y = turbo::rotr(y + v.second + Fetch64(s + 48), 42) * k1;
    x ^= w.second;
    y += v.first + Fetch64(s + 40);
    z = turbo::rotr(z + w.first, 33) * k1;
