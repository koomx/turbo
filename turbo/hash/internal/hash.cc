    ...
    namespace hash_internal {
        ...
        namespace {
            ...
            inline uint64_t Mix4x16Vectors(Vector128 a, Vector128 b, Vector128 c,
                Vector128 d) {
                Vector128 res128 = Add128(Encrypt128(Add128(a, c), d), Decrypt128(Sub128(b, d), a));
            ...
            KUMO_FORCE_INLINE uint64_t HashBlockOn32Bit(
            ...
            KUMO_FORCE_INLINE uint64_t HashBlockOn64Bit(
                uint64_t state, const unsigned char* data, size_t len) {
