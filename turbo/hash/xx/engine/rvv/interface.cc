...
namespace turbo::xxhash {
    ...
    KUMO_FORCE_INLINE void XXH3_accumulate_512_rvv(void* KUMO_RESTRICT acc,
    ...
    KUMO_FORCE_INLINE void XXH3_accumulate_rvv(uint64_t* KUMO_RESTRICT acc,
        ...
        for (n = 0; n < nbStripes; n++) {
            ...
            XXH3_accumulate_512_rvv(acc, in, secret + n * XXH_SECRET_CONSUME_RATE);
        }
    }
    ...
    KUMO_FORCE_INLINE void XXH3_initCustomSecret_rvv(void* KUMO_RESTRICT customSecret, uint64_t seed64) {
        static_assert(XXH_SEC_ALIGN >= 8, "XXH_SEC_ALIGN >= 8");
    ...
    void XXHashEngineRvv::init_custom_secret(void* KUMO_RESTRICT customSecret, uint64_t seed64) {
        XXH3_initCustomSecret_rvv(customSecret, seed64);
    }
