...
//
//   KLOG(INFO) << LogContainer(container);
//
...
//
//   KLOG(INFO) << LogContainer(container, LogMultiline());
//
...
#ifndef TURBO_LOG_INTERNAL_CONTAINER_H_
#define TURBO_LOG_INTERNAL_CONTAINER_H_
...
namespace turbo {
    namespace log_internal {
        ...
        namespace internal {
            struct LogBase {
                ...
                void Log(std::ostream &out, const ElementT &element) const { // NOLINT
                    // Fallback to `turbo_stringify` if the type does not have `operator<<`.
        ...
        //
        //   KLOG(INFO) << LogRange(start_pos, end_pos, LogMultiline());
        //
        ...
        //
        //   KLOG(INFO) << LogRange(start_pos, end_pos);
        //
...
#endif  // TURBO_LOG_INTERNAL_CONTAINER_H_
