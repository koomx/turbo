...
#ifndef TURBO_LOG_INTERNAL_GENERIC_PRINTER_H_
#define TURBO_LOG_INTERNAL_GENERIC_PRINTER_H_

#include <turbo/log/internal/generic_printer_internal.h>  // IWYU pragma: export
...
//  2. A defined turbo_stringify() method.
//  3. turbo::log_internal::LogContainer, if the object is a STL container.
...
namespace turbo {
    namespace log_internal {
        ...
        //     T v1, v2;
        //     VKLOG(1) << GenericPrint() << v1 << v2;  // GenericPrint everything
        //     VKLOG(1) << GenericPrint(v1) << v2;  // GenericPrint just v1
        //   }
        //
...
#endif  // TURBO_LOG_INTERNAL_GENERIC_PRINTER_H_
