...
KUMO_CONST_INIT KUMO_DLL extern const std::array<char, 7> kCharNull;
KUMO_CONST_INIT KUMO_DLL extern const std::array<signed char, 7>
        kSignedCharNull;
KUMO_CONST_INIT KUMO_DLL extern const std::array<unsigned char, 7>
        kUnsignedCharNull;
