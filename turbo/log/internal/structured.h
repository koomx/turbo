...
namespace turbo {
    namespace log_internal {
        ...
        public:
            explicit AsLiteralImpl(std::string_view str KUMO_ATTRIBUTE_LIFETIME_BOUND)
                : str_(str) {
            }
        ...
        private:
            ...
            void add_to_message(log_internal::LogMessage &m) {
                m.copy_to_encoded_buffer<log_internal::LogMessage::StringType::kLiteral>(str_);
            }

            friend log_internal::LogMessage &operator<<(log_internal::LogMessage &m,
                                                        AsLiteralImpl as_literal) {
                as_literal.add_to_message(m);
                return m;
            }
        };
        ...
        private:
            ...
            void add_to_message(LogMessage &m) const {
                if (str_type == StructuredStringType::kLiteral) {
                    return m.copy_to_encoded_buffer_with_structured_proto_field<
        ...
        public:
            using ValueFormatter = turbo::AnyInvocable<std::string(T) const>;
        ...
        private:
            ...
            void add_to_message(LogMessage &m) const {
                m.copy_to_encoded_buffer_with_structured_proto_field<
