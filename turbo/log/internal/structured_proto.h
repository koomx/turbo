...
#ifndef TURBO_LOG_INTERNAL_STRUCTURED_PROTO_H_
#define TURBO_LOG_INTERNAL_STRUCTURED_PROTO_H_
...
namespace turbo {
    namespace log_internal {
        ...
        struct StructuredProtoField final {
            ...
            using LengthDelimited = turbo::Span<const char>;
...
#endif  // TURBO_LOG_INTERNAL_STRUCTURED_PROTO_H_
