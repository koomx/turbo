...
//
// Eg:
//   turbo::CompressedTuple<int, T1, T2, T3> value(7, t1, t2,
//                                                                    t3);
...
namespace turbo {
    ...
    namespace internal_compressed_tuple {
        ...
        struct TURBO_INTERNAL_COMPRESSED_TUPLE_DECLSPEC Storage<T, I, Tag, true> : T {
            constexpr Storage() = default;
        ...
        struct TURBO_INTERNAL_COMPRESSED_TUPLE_DECLSPEC
