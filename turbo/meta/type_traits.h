...
namespace turbo {
...
#if KUMO_HAVE_BUILTIN(__builtin_is_cpp_trivially_relocatable)
    ...
    //
    // Applications can inspect `KUMO_HAVE_CONSTANT_EVALUATED` at compile time
    ...
    namespace type_traits_internal {
        ...
        // declaring
        //   using turbo_internal_is_view = std::false_type;
        // as a member.
