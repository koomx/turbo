...
// the `KUMO_HAVE_INTRINSIC_INT128` macro.)
//
...
// Example:
//
//     float y = turbo::Uint128Max();  // Error. uint128 cannot be implicitly
//                                    // converted to float.
//
//     turbo::uint128 v;
//     uint64_t i = v;                         // Error
...
class
 ...
 public:
  ...
  // Example:
  //
  //   turbo::uint128 big = turbo::MakeUint128(1, 0);
...
class numeric_limits<turbo::uint128> {
 public:
...
#else   // KUMO_HAVE_INTRINSIC_INT128
  ...
  static constexpr turbo::uint128(max)() { return turbo::Uint128Max(); }
...
class int128 {
 public:
  ...
  // Example:
  //
  //   turbo::int128 big = turbo::MakeInt128(1, 0);
  //   turbo::int128 big_n = turbo::MakeInt128(-1, 0);
...
class numeric_limits<turbo::int128> {
 public:
  ...
  static constexpr turbo::int128(min)() { return turbo::Int128Min(); }
  static constexpr turbo::int128 lowest() { return turbo::Int128Min(); }
  static constexpr turbo::int128(max)() { return turbo::Int128Max(); }
...
constexpr turbo::strong_ordering operator<=>(uint128 lhs, uint128 rhs) {
#if KUMO_HAVE_INTRINSIC_INT128
...
#if KUMO_HAVE_INTRINSIC_INT128
#include <turbo/numeric/int128_have_intrinsic.inc>  // IWYU pragma: export
#else  // KUMO_HAVE_INTRINSIC_INT128
