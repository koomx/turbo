...
#include <tests/random/internal/mocking_access.h>
...
class BitGenRef {
 ...
 public:
  ...
  template <typename URBGRef, typename URBG = turbo::remove_cvref_t<URBGRef>,
  ...
  BitGenRef(URBGRef&& gen KUMO_ATTRIBUTE_LIFETIME_BOUND)  // NOLINT
 ...
 private:
  ...
  friend class ::turbo::RandomMockingAccess;  // for InvokeMock
};
