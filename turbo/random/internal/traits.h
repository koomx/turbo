...
#ifndef TURBO_RANDOM_INTERNAL_TRAITS_H_
#define TURBO_RANDOM_INTERNAL_TRAITS_H_
...
template <>
struct IsIntegral<turbo::int128> : std::true_type {};
template <>
struct IsIntegral<turbo::uint128> : std::true_type {};
...
template <>
struct IsUnsigned<turbo::int128> : std::false_type {};
template <>
struct IsUnsigned<turbo::uint128> : std::true_type {};
...
#endif  // TURBO_RANDOM_INTERNAL_TRAITS_H_
