...
// UniformDistribution selects either turbo::uniform_int_distribution
// or turbo::uniform_real_distribution depending on the NumType parameter.
template <typename NumType>
using UniformDistribution =
    std::conditional_t<IsIntegral<NumType>::value,
                       turbo::uniform_int_distribution<NumType>,
                       turbo::uniform_real_distribution<NumType>>;
