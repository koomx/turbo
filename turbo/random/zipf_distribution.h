...
#ifndef TURBO_RANDOM_ZIPF_DISTRIBUTION_H_
#define TURBO_RANDOM_ZIPF_DISTRIBUTION_H_
...
// turbo::zipf_distribution produces random integer-values in the range [0, k],
  ...
  class param_type {
   ...
   private:
    ...
    static_assert(random_internal::IsIntegral<IntType>::value,
                  "Class-template turbo::zipf_distribution<> must be "
...
zipf_distribution<IntType>::param_type::param_type(
  ...
  // TODO(turbo-team): Determine if this check is needed, and if so, add a test
...
zipf_distribution<IntType>::operator()(
  ...
  turbo::uniform_real_distribution<double> uniform_double;
  double k;
  for (;;) {
...
#endif  // TURBO_RANDOM_ZIPF_DISTRIBUTION_H_
