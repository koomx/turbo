...
/// @brief turbo — C++17 foundation library (types, strings, time, status, log, flags/cli, unicode)
///
...
/// @brief Project name
/// AI: The project name is turbo.

/// @brief What turbo is
/// AI: C++17 library under turbo/<module>/. Public headers use #include <turbo/...>.
/// AI: C++ standard is 17 (cmake/turbo_user_option.cmake). Functions: snake_case.
/// AI: Read this file first; do not scan the whole tree. Module-specific skills:
/// AI:   turbo/macros/skills.h, turbo/cli/skills.h.

/// @brief Module include graph (source of truth)
/// AI: turbo/module_deps.toml is the allow-list for #include <turbo/<other>/...>.
/// AI: Same-module includes are always allowed. Layers L0–L10; no cycles.
/// AI: Changing a cross-module include: update the allow-list if the edge is new.
/// AI: Refresh / enforce:
/// AI:   python3 scripts/check_module_deps.py list-all
/// AI:   python3 scripts/check_module_deps.py list <module> -v
/// AI:   python3 scripts/check_module_deps.py check
/// AI: Pre-commit: git config core.hooksPath scripts/git-hooks
/// AI: Escape: SKIP_MODULE_DEPS=1 git commit ...

/// @brief Modules by layer (one line each; details in module headers / skills)
/// AI: L0  macros — portable compiler/platform/arch macros (no turbo/ deps)
/// AI: L1  base, meta, utility, cctz, arch — foundation + ISA helpers
/// AI: L2  bits, algorithm, cleanup, memory, functional
/// AI: L3  numeric, debugging, hash, unicode
/// AI: L4  types — Span and other vocabulary types
/// AI: L5  format — to-string / str_format
/// AI: L6  crc
/// AI: L7  strings
/// AI: L8  time, status, cord
/// AI: L9  flags, log
/// AI: L10 cli — command-line frontend (binds turbo::Flag); see turbo/cli/skills.h
/// AI: README.md mermaid copies this allow-list; toml + list-all are authoritative.
...
/// AI: CMakePresets.json base sets KMCMAKE_USE_CPM=ON.
/// AI: Test/bench CPM packages: cmake/turbo_cpm.cmake (googletest, benchmark).
...
/// AI: ├── turbo/                      # Source code
/// AI: │   ├── CMakeLists.txt
/// AI: │   ├── module_deps.toml        # Cross-module include allow-list
/// AI: │   ├── skills.h (this file)
/// AI: │   ├── version.h (generated)
/// AI: │   └── <module>/
/// AI: ├── scripts/                    # check_module_deps.py, ci_configure.py, git-hooks
...
// The version.h file is generated from turbo/version.h.in
// and contains the following compile-time macros:
/// @{
/// @brief TURBO_VERSION_MAJOR / _MINOR / _PATCH  — version components
/// @brief TURBO_VERSION_STRING  — e.g. "0.0.5"
/// @brief TURBO_SIMD_LEVEL  — target SIMD level string
/// @brief TURBO_SIMD_ENABLE_SSE..AVX512F  — 0 or 1 per feature
/// @brief TURBO_CXX_COMPILER_ID     — compiler name
/// @brief TURBO_CXX_COMPILER_VERSION — compiler version
/// @brief TURBO_BUILD_TYPE_STRING       — Debug/Release/etc
/// @brief TURBO_BUILD_SYSTEM        — OS distro name
/// @brief TURBO_GIT_COMMIT_HASH     — full git commit
/// @brief TURBO_GIT_VERSION_STRING  — "tag-hash[-dirty]"
/// @}

/// AI: Read docs/c_cpp_project_rules.md for C/C++ style and edit discipline.
/// AI: End of skills.h — prioritize this file, module skills.h, and docs/AI.md
