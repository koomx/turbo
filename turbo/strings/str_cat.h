...
// turbo::HighPrecision. HighPrecision tries to keep the string short but
...
namespace turbo {
    ...
    // `turbo::SimpleAtof`/`turbo::SimpleAtod`, would produce the exact same original
    ...
    private:
        ...
        char digits_[format_internal::kFastToBufferSize];
    };
