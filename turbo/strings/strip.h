...
//   EXPECT_EQ(input, "bc");
inline constexpr bool ConsumePrefix(std::string_view* turbo_nonnull str,
...
//   EXPECT_EQ(input, "abc");
inline constexpr bool ConsumeSuffix(std::string_view* turbo_nonnull str,
                                    std::string_view expected) {
...
[[nodiscard]] inline constexpr std::string_view StripPrefix(
...
[[nodiscard]] inline constexpr std::string_view StripSuffix(
    std::string_view str KUMO_ATTRIBUTE_LIFETIME_BOUND,
