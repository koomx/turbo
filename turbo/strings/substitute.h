...
// `turbo::SubstituteAndAppend()`. `Arg` handles implicit conversion of various
...
class Arg {
 public:
  ...
  Arg(short value)  // NOLINT(*)
      : piece_(scratch_,
               static_cast<size_t>(
                   format_internal::fast_int_to_buffer(value, scratch_) -
                   scratch_)) {}
...
//      const Args&... args) {
//    turbo::SubstituteAndAppend(boilerplate, format, args...);
//  }
//
inline void SubstituteAndAppend(std::string* turbo_nonnull output,
                                std::string_view format) {
...
void SubstituteAndAppend(std::string* turbo_nonnull output,
