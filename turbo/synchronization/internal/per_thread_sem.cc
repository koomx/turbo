...
KUMO_ATTRIBUTE_WEAK void TURBO_INTERNAL_C_SYMBOL(TurboInternalPerThreadSemInit)(
...
KUMO_ATTRIBUTE_WEAK void TURBO_INTERNAL_C_SYMBOL(TurboInternalPerThreadSemPost)(
    turbo::base_internal::ThreadIdentity *identity) {
  turbo::synchronization_internal::Waiter::GetWaiter(identity)->Post();
}

KUMO_ATTRIBUTE_WEAK void TURBO_INTERNAL_C_SYMBOL(TurboInternalPerThreadSemPoke)(
    turbo::base_internal::ThreadIdentity *identity) {
  turbo::synchronization_internal::Waiter::GetWaiter(identity)->Poke();
}

KUMO_ATTRIBUTE_WEAK bool TURBO_INTERNAL_C_SYMBOL(TurboInternalPerThreadSemWait)(
