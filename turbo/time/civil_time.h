...
//   const turbo::CivilDay cd(1969, 7, 20);
//
...
//
//   // Valid in C++14
//   constexpr turbo::CivilDay cd(1969, 7, 20);
...
template <typename Sink>
void turbo_stringify(Sink& sink, CivilMinute c) {
  sink.Append(FormatCivilTime(c));
}
template <typename Sink>
void turbo_stringify(Sink& sink, CivilHour c) {
  sink.Append(FormatCivilTime(c));
}
template <typename Sink>
void turbo_stringify(Sink& sink, CivilDay c) {
  sink.Append(FormatCivilTime(c));
}
template <typename Sink>
void turbo_stringify(Sink& sink, CivilMonth c) {
  sink.Append(FormatCivilTime(c));
}
template <typename Sink>
void turbo_stringify(Sink& sink, CivilYear c) {
  sink.Append(FormatCivilTime(c));
}
...
//
// Parses any of the formats accepted by `turbo::ParseCivilTime()`. Unlike
