...
#define TURBO_INTERNAL_TIME_HAS_THREE_WAY_COMPARISON 1
#endif
...
namespace turbo {
    ...
    namespace time_internal {
        KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Time FromUnixDuration(Duration d);
        KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Duration ToUnixDuration(Time t);
        KUMO_ATTRIBUTE_CONST_FUNCTION constexpr int64_t GetRepHi(Duration d);
        KUMO_ATTRIBUTE_CONST_FUNCTION constexpr uint32_t GetRepLo(Duration d);
        KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Duration MakeDuration(int64_t hi,
            uint32_t lo);
        KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Duration MakeDuration(int64_t hi,
            int64_t lo);
        KUMO_ATTRIBUTE_CONST_FUNCTION inline Duration MakePosDoubleDuration(double n);
        constexpr int64_t kTicksPerNanosecond = 4;
        constexpr int64_t kTicksPerSecond = 1000 * 1000 * 1000 * kTicksPerNanosecond;
        template <std::intmax_t N>
        KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Duration FromInt64(int64_t v,
            std::ratio<1, N>);
        KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Duration FromInt64(int64_t v,
            std::ratio<60>);
        KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Duration FromInt64(int64_t v,
            std::ratio<3600>);
        template <typename T>
        using EnableIfIntegral = std::enable_if_t<std::is_integral_v<T> || std::is_enum_v<T>, int>;
        template <typename T>
    ...
    public:
        ...
        constexpr Duration()
            : rep_hi_(0)
            , rep_lo_(0) { } // zero-length duration
    ...
    private:
        ...
        public:
            ...
            constexpr int64_t Get() const {
                const uint64_t unsigned_value = (static_cast<uint64_t>(hi_) << 32) | static_cast<uint64_t>(lo_);
                ...
                // destination type."
                static_assert(
                    (static_cast<int64_t>((std::numeric_limits<uint64_t>::max)()) == int64_t { -1 }) && (static_cast<int64_t>(static_cast<uint64_t>((std::numeric_limits<int64_t>::max)()) + 1) == (std::numeric_limits<int64_t>::min)()),
...
#ifdef TURBO_INTERNAL_TIME_HAS_THREE_WAY_COMPARISON

    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr std::strong_ordering operator<=>(
        Duration lhs, Duration rhs);

#endif // TURBO_INTERNAL_TIME_HAS_THREE_WAY_COMPARISON

    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr bool operator<(Duration lhs,
        Duration rhs);
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr bool operator>(Duration lhs,
        Duration rhs) {
        return rhs < lhs;
    ...
    // Additive Operators
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Duration operator-(Duration d);
    KUMO_ATTRIBUTE_CONST_FUNCTION inline Duration operator+(Duration lhs,
        Duration rhs) {
        return lhs += rhs;
    }
    KUMO_ATTRIBUTE_CONST_FUNCTION inline Duration operator-(Duration lhs,
    ...
    //   // d == 1.5
    KUMO_ATTRIBUTE_CONST_FUNCTION double FDivDuration(Duration num, Duration den);

    // Multiplicative Operators
    // Integer operands must be representable as int64_t.
    template <typename T>
    KUMO_ATTRIBUTE_CONST_FUNCTION Duration operator*(Duration lhs, T rhs) {
        return lhs *= rhs;
    }
    template <typename T>
    KUMO_ATTRIBUTE_CONST_FUNCTION Duration operator*(T lhs, Duration rhs) {
        return rhs *= lhs;
    }
    template <typename T>
    KUMO_ATTRIBUTE_CONST_FUNCTION Duration operator/(Duration lhs, T rhs) {
    ...
    KUMO_ATTRIBUTE_CONST_FUNCTION inline int64_t operator/(Duration lhs,
        Duration rhs) {
    ...
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Duration ZeroDuration() {
        return Duration();
    }
    ...
    KUMO_ATTRIBUTE_CONST_FUNCTION inline Duration AbsDuration(Duration d) {
    ...
    KUMO_ATTRIBUTE_CONST_FUNCTION Duration Trunc(Duration d, Duration unit);
    ...
    KUMO_ATTRIBUTE_CONST_FUNCTION Duration Floor(Duration d, Duration unit);
    ...
    KUMO_ATTRIBUTE_CONST_FUNCTION Duration Ceil(Duration d, Duration unit);
    ...
    // and `FDivDuration()`.
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Duration InfiniteDuration();
    ...
    template <typename T, time_internal::EnableIfIntegral<T> = 0>
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Duration Nanoseconds(T n) {
        return time_internal::FromInt64(n, std::nano { });
    }
    template <typename T, time_internal::EnableIfIntegral<T> = 0>
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Duration Microseconds(T n) {
        return time_internal::FromInt64(n, std::micro { });
    }
    template <typename T, time_internal::EnableIfIntegral<T> = 0>
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Duration Milliseconds(T n) {
        return time_internal::FromInt64(n, std::milli { });
    }
    template <typename T, time_internal::EnableIfIntegral<T> = 0>
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Duration Seconds(T n) {
        return time_internal::FromInt64(n, std::ratio<1> { });
    }
    template <typename T, time_internal::EnableIfIntegral<T> = 0>
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Duration Minutes(T n) {
        return time_internal::FromInt64(n, std::ratio<60> { });
    }
    template <typename T, time_internal::EnableIfIntegral<T> = 0>
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Duration Hours(T n) {
    ...
    template <typename T, time_internal::EnableIfFloat<T> = 0>
    KUMO_ATTRIBUTE_CONST_FUNCTION Duration Nanoseconds(T n) {
        return n * Nanoseconds(1);
    }
    template <typename T, time_internal::EnableIfFloat<T> = 0>
    KUMO_ATTRIBUTE_CONST_FUNCTION Duration Microseconds(T n) {
        return n * Microseconds(1);
    }
    template <typename T, time_internal::EnableIfFloat<T> = 0>
    KUMO_ATTRIBUTE_CONST_FUNCTION Duration Milliseconds(T n) {
        return n * Milliseconds(1);
    }
    template <typename T, time_internal::EnableIfFloat<T> = 0>
    KUMO_ATTRIBUTE_CONST_FUNCTION Duration Seconds(T n) {
    ...
    template <typename T, time_internal::EnableIfFloat<T> = 0>
    KUMO_ATTRIBUTE_CONST_FUNCTION Duration Minutes(T n) {
        return n * Minutes(1);
    }
    template <typename T, time_internal::EnableIfFloat<T> = 0>
    KUMO_ATTRIBUTE_CONST_FUNCTION Duration Hours(T n) {
        return n * Hours(1);
    }
    ...
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr int64_t ToInt64Nanoseconds(Duration d);
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr int64_t ToInt64Microseconds(Duration d);
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr int64_t ToInt64Milliseconds(Duration d);
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr int64_t ToInt64Seconds(Duration d);
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr int64_t ToInt64Minutes(Duration d);
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr int64_t ToInt64Hours(Duration d);
    ...
    KUMO_ATTRIBUTE_CONST_FUNCTION double ToDoubleNanoseconds(Duration d);
    KUMO_ATTRIBUTE_CONST_FUNCTION double ToDoubleMicroseconds(Duration d);
    KUMO_ATTRIBUTE_CONST_FUNCTION double ToDoubleMilliseconds(Duration d);
    KUMO_ATTRIBUTE_CONST_FUNCTION double ToDoubleSeconds(Duration d);
    KUMO_ATTRIBUTE_CONST_FUNCTION double ToDoubleMinutes(Duration d);
    KUMO_ATTRIBUTE_CONST_FUNCTION double ToDoubleHours(Duration d);
    ...
    KUMO_ATTRIBUTE_PURE_FUNCTION constexpr Duration FromChrono(
    ...
    KUMO_ATTRIBUTE_CONST_FUNCTION std::chrono::nanoseconds ToChronoNanoseconds(
        Duration d);
    KUMO_ATTRIBUTE_CONST_FUNCTION std::chrono::microseconds ToChronoMicroseconds(
        Duration d);
    KUMO_ATTRIBUTE_CONST_FUNCTION std::chrono::milliseconds ToChronoMilliseconds(
        Duration d);
    KUMO_ATTRIBUTE_CONST_FUNCTION std::chrono::seconds ToChronoSeconds(Duration d);
    KUMO_ATTRIBUTE_CONST_FUNCTION std::chrono::minutes ToChronoMinutes(Duration d);
    KUMO_ATTRIBUTE_CONST_FUNCTION std::chrono::hours ToChronoHours(Duration d);

    // FormatDuration()
    //
    // Returns a string representing the duration in the form "72h3m0.5s".
    // Returns "inf" or "-inf" for +/- `InfiniteDuration()`.
    KUMO_ATTRIBUTE_CONST_FUNCTION std::string FormatDuration(Duration d);
    ...
    bool ParseDuration(std::string_view dur_string, Duration* d);
    ...
    // created using `turbo::Now()` and the `turbo::From*()` factory functions that
    // accept the gamut of other time representations. Formatting and parsing
    // functions are provided for conversion to and from strings. `turbo::Time` is
    ...
    public:
        ...
        //   turbo::Time t = turbo::Now();
        //   turbo::Time t = turbo::TimeFromTimeval(tv);
        //   turbo::Time t = turbo::InfinitePast();
...
// Relational Operators
    ...
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr bool operator<(Time lhs, Time rhs) {
        return lhs.rep_ < rhs.rep_;
    }
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr bool operator>(Time lhs, Time rhs) {
        return rhs < lhs;
    ...
    // Additive Operators
    KUMO_ATTRIBUTE_CONST_FUNCTION inline Time operator+(Time lhs, Duration rhs) {
        return lhs += rhs;
    }
    KUMO_ATTRIBUTE_CONST_FUNCTION inline Time operator+(Duration lhs, Time rhs) {
        return rhs += lhs;
    }
    KUMO_ATTRIBUTE_CONST_FUNCTION inline Time operator-(Time lhs, Duration rhs) {
        return lhs -= rhs;
    }
    KUMO_ATTRIBUTE_CONST_FUNCTION inline Duration operator-(Time lhs, Time rhs) {
        return lhs.rep_ - rhs.rep_;
    }
    ...
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Time UnixEpoch() {
        return Time();
    }
    ...
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Time UniversalEpoch() {
    ...
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Time InfiniteFuture() {
    ...
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Time InfinitePast() {
    ...
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Time FromUnixNanos(int64_t ns);
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Time FromUnixMicros(int64_t us);
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Time FromUnixMillis(int64_t ms);
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Time FromUnixSeconds(int64_t s);
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Time FromTimeT(time_t t);
    KUMO_ATTRIBUTE_CONST_FUNCTION Time FromUDate(double udate);
    KUMO_ATTRIBUTE_CONST_FUNCTION Time FromUniversal(int64_t universal);
    ...
    KUMO_ATTRIBUTE_CONST_FUNCTION int64_t ToUnixNanos(Time t);
    KUMO_ATTRIBUTE_CONST_FUNCTION int64_t ToUnixMicros(Time t);
    KUMO_ATTRIBUTE_CONST_FUNCTION int64_t ToUnixMillis(Time t);
    KUMO_ATTRIBUTE_CONST_FUNCTION int64_t ToUnixSeconds(Time t);
    KUMO_ATTRIBUTE_CONST_FUNCTION time_t ToTimeT(Time t);
    KUMO_ATTRIBUTE_CONST_FUNCTION double ToUDate(Time t);
    KUMO_ATTRIBUTE_CONST_FUNCTION int64_t ToUniversal(Time t);
    ...
    KUMO_ATTRIBUTE_CONST_FUNCTION Duration DurationFromTimespec(timespec ts);
    KUMO_ATTRIBUTE_CONST_FUNCTION Duration DurationFromTimeval(timeval tv);
    KUMO_ATTRIBUTE_CONST_FUNCTION timespec ToTimespec(Duration d);
    KUMO_ATTRIBUTE_CONST_FUNCTION timeval ToTimeval(Duration d);
    KUMO_ATTRIBUTE_CONST_FUNCTION Time TimeFromTimespec(timespec ts);
    KUMO_ATTRIBUTE_CONST_FUNCTION Time TimeFromTimeval(timeval tv);
    KUMO_ATTRIBUTE_CONST_FUNCTION timespec ToTimespec(Time t);
    KUMO_ATTRIBUTE_CONST_FUNCTION timeval ToTimeval(Time t);
    ...
    KUMO_ATTRIBUTE_PURE_FUNCTION Time
    ...
    KUMO_ATTRIBUTE_CONST_FUNCTION std::chrono::system_clock::time_point
        ToChronoTime(Time);
    ...
    inline bool LoadTimeZone(std::string_view name, TimeZone* tz) {
        if (name == "localtime") {
    ...
    KUMO_ATTRIBUTE_PURE_FUNCTION inline CivilSecond ToCivilSecond(Time t,
        TimeZone tz) {
        return tz.At(t).cs; // already a CivilSecond
    }
    KUMO_ATTRIBUTE_PURE_FUNCTION inline CivilMinute ToCivilMinute(Time t,
        TimeZone tz) {
        return CivilMinute(tz.At(t).cs);
    }
    KUMO_ATTRIBUTE_PURE_FUNCTION inline CivilHour ToCivilHour(Time t, TimeZone tz) {
        return CivilHour(tz.At(t).cs);
    }
    KUMO_ATTRIBUTE_PURE_FUNCTION inline CivilDay ToCivilDay(Time t, TimeZone tz) {
        return CivilDay(tz.At(t).cs);
    }
    KUMO_ATTRIBUTE_PURE_FUNCTION inline CivilMonth ToCivilMonth(Time t,
        TimeZone tz) {
        return CivilMonth(tz.At(t).cs);
    }
    KUMO_ATTRIBUTE_PURE_FUNCTION inline CivilYear ToCivilYear(Time t, TimeZone tz) {
    ...
    KUMO_ATTRIBUTE_PURE_FUNCTION inline Time FromCivil(CivilSecond ct,
        TimeZone tz) {
    ...
    // happened.
    KUMO_ATTRIBUTE_PURE_FUNCTION Time FromTM(const struct tm& tm, TimeZone tz);

    // ToTM()
    //
    // Converts the given `turbo::Time` to a struct tm using the given time zone.
    // See ctime(3) for a description of the values of the tm fields.
    KUMO_ATTRIBUTE_PURE_FUNCTION struct tm ToTM(Time t, TimeZone tz);
    ...
    // `turbo::Time` will be `turbo::InfiniteFuture()` and `true` will be returned.
    ...
    namespace time_internal {
        ...
        KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Duration MakeNormalizedDuration(
        ...
        KUMO_ATTRIBUTE_CONST_FUNCTION constexpr bool IsInfiniteDuration(Duration d) {
            return GetRepLo(d) == ~uint32_t { 0 };
        }

        // Returns an infinite Duration with the opposite sign.
        // REQUIRES: IsInfiniteDuration(d)
        KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Duration OppositeInfinity(Duration d) {
            return GetRepHi(d) < 0
        ...
        KUMO_ATTRIBUTE_CONST_FUNCTION constexpr int64_t NegateAndSubtractOne(
            int64_t n) {
        ...
        KUMO_ATTRIBUTE_CONST_FUNCTION int64_t ToInt64(Duration d, Ratio) {
            // Note: This may be used on MSVC, which may have a system_clock period of
            // std::ratio<1, 10 * 1000 * 1000>
            return ToInt64Seconds(d * Ratio::den / Ratio::num);
        }
        // Fastpath implementations for the 6 common duration units.
        KUMO_ATTRIBUTE_CONST_FUNCTION inline int64_t ToInt64(Duration d, std::nano) {
            return ToInt64Nanoseconds(d);
        }
        KUMO_ATTRIBUTE_CONST_FUNCTION inline int64_t ToInt64(Duration d, std::micro) {
            return ToInt64Microseconds(d);
        }
        KUMO_ATTRIBUTE_CONST_FUNCTION inline int64_t ToInt64(Duration d, std::milli) {
            return ToInt64Milliseconds(d);
        }
        KUMO_ATTRIBUTE_CONST_FUNCTION inline int64_t ToInt64(Duration d,
            std::ratio<1>) {
        ...
        template <typename T>
        KUMO_ATTRIBUTE_CONST_FUNCTION T ToChronoDuration(Duration d) {
    ...
    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr int64_t ToInt64Nanoseconds(Duration d) {
        if (time_internal::GetRepHi(d) >= 0 && time_internal::GetRepHi(d) >> 33 == 0) {
            return (time_internal::GetRepHi(d) * 1000 * 1000 * 1000) + (time_internal::GetRepLo(d) / time_internal::kTicksPerNanosecond);
        } else {
            return d / Nanoseconds(1);
        }
    }

    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr int64_t ToInt64Microseconds(
        Duration d) {
        if (time_internal::GetRepHi(d) >= 0 && time_internal::GetRepHi(d) >> 43 == 0) {
            return (time_internal::GetRepHi(d) * 1000 * 1000) + (time_internal::GetRepLo(d) / (time_internal::kTicksPerNanosecond * 1000));
        } else {
            return d / Microseconds(1);
        }
    }

    KUMO_ATTRIBUTE_CONST_FUNCTION constexpr int64_t ToInt64Milliseconds(
        Duration d) {
        if (time_internal::GetRepHi(d) >= 0 && time_internal::GetRepHi(d) >> 53 == 0) {
            return (time_internal::GetRepHi(d) * 1000) + (time_internal::GetRepLo(d) / (time_internal::kTicksPerNanosecond * 1000 * 1000));
        } else {
