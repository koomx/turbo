...
// `turbo::ParseDuration()`.
bool TurboParseFlag(std::string_view text, Duration* dst, std::string* error);
...
KUMO_DEPRECATED("Use TurboParseFlag() instead.")
bool ParseFlag(const std::string& text, Duration* dst, std::string* error);
KUMO_DEPRECATED("Use TurboUnparseFlag() instead.")
...
class Time {
 public:
  ...
  struct KUMO_DEPRECATED("Use `turbo::TimeZone::CivilInfo`.") Breakdown {
  ...
  KUMO_DEPRECATED("Use `turbo::TimeZone::At(Time)`.")
...
KUMO_ATTRIBUTE_CONST_FUNCTION constexpr Time UnixEpoch() { return Time(); }
...
bool TurboParseFlag(std::string_view text, Time* t, std::string* error);
...
struct KUMO_DEPRECATED("Use `turbo::TimeZone::TimeInfo`.") TimeConversion {
  Time pre;    // time calculated using the pre-transition offset
  Time trans;  // when the civil-time discontinuity occurred
  Time post;   // time calculated using the post-transition offset
...
KUMO_INTERNAL_DISABLE_DEPRECATED_DECLARATION_WARNING
KUMO_DEPRECATED("Use `turbo::TimeZone::At(CivilSecond)`.")
...
KUMO_DEPRECATED("Use `turbo::FromCivil(CivilSecond, TimeZone)`.")
