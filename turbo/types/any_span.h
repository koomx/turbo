...
// -----------------------------------------------------------------------------
//
// AnySpan provides a view of a random access container, much like turbo::Span
// (go/totw/93). See also go/totw/145#gtlanyspan for an introduction of AnySpan.
//
// The primary differences from turbo::Span are:
...
// read-only view to the elements, similar to turbo::Span.
//
...
//
//   turbo::Span<MyMessage> mutable_span = ...;
