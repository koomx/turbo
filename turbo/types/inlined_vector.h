...
namespace turbo {
    ...
    public:
        ...
        iterator begin() noexcept KUMO_ATTRIBUTE_LIFETIME_BOUND { return data(); }

        // Overload of `InlinedVector::begin()` that returns a `const_iterator` to
        // the beginning of the inlined vector.
        const_iterator begin() const noexcept KUMO_ATTRIBUTE_LIFETIME_BOUND {
            return data();
        }
        ...
        iterator end() noexcept KUMO_ATTRIBUTE_LIFETIME_BOUND {
            return data() + size();
        }

        // Overload of `InlinedVector::end()` that returns a `const_iterator` to the
        // end of the inlined vector.
        const_iterator end() const noexcept KUMO_ATTRIBUTE_LIFETIME_BOUND {
            return data() + size();
        }
        ...
        const_iterator cbegin() const noexcept KUMO_ATTRIBUTE_LIFETIME_BOUND {
            return begin();
        }
        ...
        const_iterator cend() const noexcept KUMO_ATTRIBUTE_LIFETIME_BOUND {
            return end();
        }
        ...
        reverse_iterator rbegin() noexcept KUMO_ATTRIBUTE_LIFETIME_BOUND {
            return reverse_iterator(end());
        }

        // Overload of `InlinedVector::rbegin()` that returns a
        // `const_reverse_iterator` from the end of the inlined vector.
        const_reverse_iterator rbegin() const noexcept KUMO_ATTRIBUTE_LIFETIME_BOUND {
        ...
        reverse_iterator rend() noexcept KUMO_ATTRIBUTE_LIFETIME_BOUND {
            return reverse_iterator(begin());
        }

        // Overload of `InlinedVector::rend()` that returns a `const_reverse_iterator`
        // from the beginning of the inlined vector.
        const_reverse_iterator rend() const noexcept KUMO_ATTRIBUTE_LIFETIME_BOUND {
        ...
        // vector.
        const_reverse_iterator crend() const noexcept KUMO_ATTRIBUTE_LIFETIME_BOUND {
            return rend();
        }
...
#pragma GCC diagnostic pop
        ...
        iterator insert(const_iterator pos, ForwardIterator first,
            ...
            turbo::base_internal::HardeningAssertLE(pos, cend());
            const size_type s = static_cast<size_type>(std::distance(first, last));
            if (KUMO_UNLIKELY(s > max_size() - size())) {
                ThrowStdLengthError("InlinedVector::insert failed length check");
            }

            if (KUMO_LIKELY(first != last)) {
...
#pragma GCC diagnostic pop
        ...
        iterator erase(const_iterator pos) KUMO_ATTRIBUTE_LIFETIME_BOUND {
            turbo::base_internal::HardeningAssertGE(pos, cbegin());
            turbo::base_internal::HardeningAssertLT(pos, cend());
