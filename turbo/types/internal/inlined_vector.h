...
#pragma GCC diagnostic ignored "-Warray-bounds"
        ...
        template<typename A,
            bool IsOverAligned =
                    (alignof(ValueType<A>) > KUMO_DEFAULT_NEW_ALIGNMENT)>
        ...
        void ConstructElements(turbo::type_identity_t<A> &allocator,
            ...
            for (SizeType<A> i = 0; i < construct_size; ++i) {
                KUMO_INTERNAL_TRY { values.ConstructNext(allocator, construct_first + i); }
...
#pragma GCC diagnostic pop
            ...
            void MemcpyFrom(const Storage &other_storage) {
                ...
                {
                    using V = ValueType<A>;
                    KUMO_ASSERT(other_storage.GetIsAllocated() ||
        ...
        auto Storage<T, N, A>::Erase(ConstIterator<A> from,
            ...
            if (turbo::is_trivially_relocatable<ValueType<A> >::value &&
        ...
        auto Storage<T, N, A>::Reserve(SizeType<A> requested_capacity) -> void {
            ...
            if (KUMO_UNLIKELY(requested_capacity <= storage_view.capacity)) return;
        ...
        auto Storage<T, N, A>::ShrinkToFit() -> void {
            ...
            if (KUMO_UNLIKELY(storage_view.size == storage_view.capacity)) return;
