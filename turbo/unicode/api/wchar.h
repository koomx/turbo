...
namespace turbo {
    ...
    std::wstring convert_utf8_to_wchar(std::string_view wc);
    ...
    struct WidecharRange {
        int32_t lo;
        int32_t hi;
    };

    /* Private usage range. */
    static const struct WidecharRange widechar_private_table[] = {
        { 0x0E000, 0x0F8FF }, { 0xF0000, 0xFFFFD }, { 0x100000, 0x10FFFD }
    };

    /* Nonprinting characters. */
    static const struct WidecharRange widechar_nonprint_table[] = {
    ...
    static const struct WidecharRange widechar_combining_table[] = {
    ...
    /* Width.2 characters. */
    static const struct WidecharRange widechar_doublewide_table[] = {
    ...
    static const struct WidecharRange widechar_ambiguous_table[] = {
    ...
    static const struct WidecharRange widechar_unassigned_table[] = {
    ...
    static const struct WidecharRange widechar_widened_table[] = {
    ...
    bool widechar_in_table(const Collection& arr, int32_t c) {
        auto where = std::lower_bound(std::begin(arr), std::end(arr), c,
            [](WidecharRange p, int32_t chr) { return p.hi < chr; });
