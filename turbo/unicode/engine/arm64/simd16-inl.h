...
struct base_u16 {
    ...
    KUMO_FORCE_INLINE base_u16() = default;
    KUMO_FORCE_INLINE base_u16(const uint16x8_t _value)
        : value(_value) { }
    KUMO_FORCE_INLINE operator const uint16x8_t&() const {
        return this->value;
    }
    KUMO_FORCE_INLINE operator uint16x8_t&() { return this->value; }
    // Bit operations
    KUMO_FORCE_INLINE simd16<T> operator|(const simd16<T> other) const {
    ...
    KUMO_FORCE_INLINE simd16<T> bit_andnot(const simd16<T> other) const {
        return vbicq_u16(*this, other);
    }
    KUMO_FORCE_INLINE simd16<T> operator~() const { return *this ^ 0xFFu; }
    KUMO_FORCE_INLINE simd16<T>& operator|=(const simd16<T> other) {
    ...
    friend KUMO_FORCE_INLINE Mask operator==(const simd16<T> lhs,
        const simd16<T> rhs) {
...
struct base16 : base_u16<T> {
    ...
    KUMO_FORCE_INLINE base16()
        : base_u16<T>() { }
    KUMO_FORCE_INLINE base16(const uint16x8_t _value)
        : base_u16<T>(_value) { }
    template <typename Pointer>
    KUMO_FORCE_INLINE base16(const Pointer* ptr)
...
struct simd16<bool> : base16<bool> {
    static KUMO_FORCE_INLINE simd16<bool> splat(bool _value) {
    ...
    KUMO_FORCE_INLINE simd16(const uint16x8_t _value)
        : base16<bool>(_value) { }
    // Splat constructor
    KUMO_FORCE_INLINE simd16(bool _value)
        : base16<bool>(splat(_value)) { }
};

template <typename T>
struct base16_numeric : base16<T> {
    static KUMO_FORCE_INLINE simd16<T> splat(T _value) {
        return vmovq_n_u16(_value);
    }
    static KUMO_FORCE_INLINE simd16<T> zero() { return vdupq_n_u16(0); }
    static KUMO_FORCE_INLINE simd16<T> load(const T values[8]) {
        return vld1q_u16(reinterpret_cast<const uint16_t*>(values));
    }

    KUMO_FORCE_INLINE base16_numeric()
        : base16<T>() { }
    KUMO_FORCE_INLINE base16_numeric(const uint16x8_t _value)
        : base16<T>(_value) { }

    // Store to array
    KUMO_FORCE_INLINE void store(T dst[8]) const {
...
#endif
    KUMO_FORCE_INLINE simd16(const int16x8_t _value)
        : base16_numeric<int16_t>(vreinterpretq_u16_s16(_value)) { }

    // Splat constructor
    KUMO_FORCE_INLINE simd16(int16_t _value)
        : simd16(splat(_value)) { }
    // Array constructor
    KUMO_FORCE_INLINE simd16(const int16_t* values)
        : simd16(load(values)) { }
    KUMO_FORCE_INLINE simd16(const char16_t* values)
        : simd16(load(reinterpret_cast<const int16_t*>(values))) { }
    KUMO_FORCE_INLINE operator simd16<uint16_t>() const;
    KUMO_FORCE_INLINE operator const uint16x8_t&() const {
        return this->value;
    }
    KUMO_FORCE_INLINE operator const int16x8_t() const {
        return vreinterpretq_s16_u16(this->value);
    }

    KUMO_FORCE_INLINE int16_t max_val() const {
        return vmaxvq_s16(vreinterpretq_s16_u16(this->value));
    }
    KUMO_FORCE_INLINE int16_t min_val() const {
        return vminvq_s16(vreinterpretq_s16_u16(this->value));
    }
    // Order-sensitive comparisons
    KUMO_FORCE_INLINE simd16<int16_t>
...
struct simd16<uint16_t> : base16_numeric<uint16_t> {
    ...
    // Splat constructor
    KUMO_FORCE_INLINE simd16(uint16_t _value)
        : simd16(splat(_value)) { }
    // Array constructor
    KUMO_FORCE_INLINE simd16(const uint16_t* values)
        : simd16(load(values)) { }
    KUMO_FORCE_INLINE simd16(const char16_t* values)
        : simd16(load(reinterpret_cast<const uint16_t*>(values))) { }

    KUMO_FORCE_INLINE int16_t max_val() const { return vmaxvq_u16(*this); }
    KUMO_FORCE_INLINE int16_t min_val() const { return vminvq_u16(*this); }
    // Saturated math
    KUMO_FORCE_INLINE simd16<uint16_t>
    ...
    KUMO_FORCE_INLINE simd16<bool> bits_not_set() const {
        return *this == uint16_t(0);
    }
    template <int N>
    KUMO_FORCE_INLINE simd16<uint16_t> shr() const {
        return simd16<uint16_t>(vshrq_n_u16(*this, N));
    }
    template <int N>
    KUMO_FORCE_INLINE simd16<uint16_t> shl() const {
        return simd16<uint16_t>(vshlq_n_u16(*this, N));
    }

    // Pack with the unsigned saturation of two uint16_t code units into single
    // uint8_t vector
    static KUMO_FORCE_INLINE simd8<uint8_t> pack(const simd16<uint16_t>& v0,
    ...
    KUMO_FORCE_INLINE uint32_t sum() const { return vaddlvq_u16(value); }
};

KUMO_FORCE_INLINE simd16<int16_t>::operator simd16<uint16_t>() const {
    return this->value;
}
...
struct simd16x32 {
    ...
    KUMO_FORCE_INLINE simd16x32(const T* ptr)
    ...
    KUMO_FORCE_INLINE simd16<T> reduce_or() const {
    ...
    KUMO_FORCE_INLINE void swap_bytes() {
    ...
    KUMO_FORCE_INLINE uint64_t lteq(const T m) const {
        const simd16<T> mask = simd16<T>::splat(m);
        return simd16x32<bool>(this->chunks[0] <= mask, this->chunks[1] <= mask,
            this->chunks[2] <= mask, this->chunks[3] <= mask)
            .to_bitmask();
    ...
    KUMO_FORCE_INLINE uint64_t not_in_range(const T low, const T high) const {
...
template <>
KUMO_FORCE_INLINE uint64_t simd16x32<uint16_t>::not_in_range(
...
KUMO_FORCE_INLINE simd16<uint16_t> min(const simd16<uint16_t> a,
    simd16<uint16_t> b) {
