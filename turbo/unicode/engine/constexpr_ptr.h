...
namespace simdutf {
    namespace detail {
        ...
        struct constexpr_ptr {
            ...
            constexpr explicit constexpr_ptr(const from* ptr) noexcept
                : p(ptr) { }
        ...
        struct constexpr_write_ptr_proxy {
            ...
            constexpr explicit constexpr_write_ptr_proxy(TargetType* raw)
                : p(raw) { }
        ...
        struct constexpr_write_ptr {
            constexpr explicit constexpr_write_ptr(TargetType* raw)
                : p(raw) { }
