#include "../../../macros/attributes/function.h"
#ifdef __GNUC__
#if __GNUC__ < 8
...
struct base16 : base<simd16<T>> {
    ...
    KUMO_FORCE_INLINE base16()
        : base<simd16<T>>() { }
    KUMO_FORCE_INLINE base16(const __m256i _value)
...
struct simd16<bool> : base16<bool> {
    ...
    KUMO_FORCE_INLINE simd16(const __m256i _value)
        : base16<bool>(_value) { }
    ...
    KUMO_FORCE_INLINE simd16<bool> operator~() const { return *this ^ true; }
};
...
struct base16_numeric : base16<T> {
    ...
    static KUMO_FORCE_INLINE simd16<T> zero() {
    ...
    KUMO_FORCE_INLINE base16_numeric(const __m256i _value)
        : base16<T>(_value) { }
    ...
    KUMO_FORCE_INLINE simd16<T> operator~() const { return *this ^ 0xFFFFu; }
...
struct simd16<uint16_t> : base16_numeric<uint16_t> {
    ...
    KUMO_FORCE_INLINE simd16<bool> any_bits_set() const {
...
struct simd16x32 {
    ...
    KUMO_FORCE_INLINE simd16x32(const simd16<T> chunk0,
