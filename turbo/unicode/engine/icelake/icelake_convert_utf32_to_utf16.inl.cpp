...
avx512_convert_utf32_to_utf16(const char32_t* buf, size_t len,
    ...
    while (end - buf >= std::ptrdiff_t(16)) {
        ...
        const __mmask16 saturation_bitmask = _mm512_cmpeq_epi32_mask(_mm512_and_si512(in, v_ffff0000), v_00000000);
    ...
    if (remaining_len) {
        ...
        const __mmask16 saturation_bitmask = _mm512_cmpeq_epi32_mask(_mm512_and_si512(in, v_ffff0000), v_00000000) & input_mask;
        if (saturation_bitmask == input_mask) {
            ...
            const __mmask32 output_max_mask = __mmask32((uint64_t(1) << (remaining_len * 2)) - 1);
            const __mmask32 output_mask = (~_pdep_u32(saturation_bitmask, 0xAAAAAAAA)) & output_max_mask;
            const __mmask16 surrogate_bitmask = __mmask16(~saturation_bitmask) & input_mask;
            __mmask32 error = _mm512_mask_cmpeq_epi32_mask(
                saturation_bitmask, _mm512_and_si512(in, v_f800), v_d800);
            error |= _mm512_mask_cmpgt_epu32_mask(surrogate_bitmask, in, v_10ffff);
            if (simdutf_unlikely(error)) {
...
avx512_convert_utf32_to_utf16_with_errors(const char32_t* buf, size_t len,
    ...
    if (remaining_len) {
        ...
        if (saturation_bitmask == input_mask) {
            ...
            const __mmask32 output_max_mask = __mmask32((uint64_t(1) << (remaining_len * 2)) - 1);
            __mmask32 output_mask = (~_pdep_u32(saturation_bitmask, 0xAAAAAAAA)) & output_max_mask;
            const __mmask16 surrogate_bitmask = __mmask16(~saturation_bitmask) & input_mask;
            __mmask32 error_surrogate = _mm512_mask_cmpeq_epi32_mask(
                saturation_bitmask, _mm512_and_si512(in, v_f800), v_d800);
            __mmask32 error_too_large = _mm512_mask_cmpgt_epu32_mask(surrogate_bitmask, in, v_10ffff);
