...
KUMO_FORCE_INLINE void utf16fix_block(char16_t* out, const char16_t* in) {
    ...
    lb_masked = _mm512_and_epi32(lookback, _mm512_set1_epi16(swap_if_needed(0xfc00U)));
    block_masked = _mm512_and_epi32(block, _mm512_set1_epi16(swap_if_needed(0xfc00U)));
    ...
    if (!_ktestz_mask32_u8(illseq, illseq)) {
        ...
        if (in_place) {
            ...
            _mm512_storeu_epi32(
                out, _mm512_mask_blend_epi16(block_illseq, block, _mm512_set1_epi16(replacement)));
        }
    } else if (!in_place) {
