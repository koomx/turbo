...
#if SIMDUTF_CPLUSPLUS23
        if consteval {
            const full_result r = scalar::utf16_to_utf8::convert_with_errors<endianness::NATIVE, true>(
                utf16_input.data(), utf16_input.size(), utf8_output.data(),
                utf8_output.size());
...
#if SIMDUTF_FEATURE_BASE64 || SIMDUTF_FEATURE_UTF16 || SIMDUTF_FEATURE_DETECT_ENCODING
