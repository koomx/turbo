...
lasx_convert_latin1_to_utf8(const char* latin1_input, size_t len,
    ...
    while (end - latin1_input >= std::ptrdiff_t(16 + safety_margin)) {
        ...
        __m128i utf8_packed0 = __lsx_vshuf_b(utf8_unpacked_lo, utf8_unpacked_lo, shuffle0);
        ...
        __m128i utf8_packed1 = __lsx_vshuf_b(utf8_unpacked_hi, utf8_unpacked_hi, shuffle1);
