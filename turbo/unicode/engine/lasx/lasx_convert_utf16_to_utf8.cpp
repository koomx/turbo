...
lasx_convert_utf16_to_utf8(const char16_t* buf, size_t len, char* utf8_out) {
    ...
    while (end - buf >= std::ptrdiff_t(16 + safety_margin)) {
        ...
        if (__lasx_xbnz_h(__lasx_xvslt_hu(
            ...
            // 1. pack the bytes
            __m256i utf8_packed = __lasx_xvpermi_d(__lasx_xvpickev_b(in, in), 0b00001000);
            // 2. store (16 bytes)
        ...
        if (__lasx_xbz_v(__lasx_xvslt_hu(v_07ff, in))) {
            ...
            __m256i one_byte_bytemask = __lasx_xvsle_hu(in, __lasx_xvrepli_h(0x7F /*0x007F*/));
            ...
            __m128i utf8_packed1 = __lsx_vshuf_b(zero_128, lasx_extracti128_lo(utf8_unpacked), shuffle1);
            ...
            __m128i utf8_packed2 = __lsx_vshuf_b(zero_128, lasx_extracti128_hi(utf8_unpacked), shuffle2);
            // 5. store bytes
        ...
        if (__lasx_xbz_v(surrogates_bytemask)) {
            ...
            __m256i one_byte_bytemask_low = __lasx_xvilvl_h(one_byte_bytemask, one_byte_bytemask);
            __m256i one_byte_bytemask_high = __lasx_xvilvh_h(one_byte_bytemask, one_byte_bytemask);

            __m256i one_or_two_bytes_bytemask_low = __lasx_xvilvl_h(one_or_two_bytes_bytemask, zero);
            __m256i one_or_two_bytes_bytemask_high = __lasx_xvilvh_h(one_or_two_bytes_bytemask, zero);
