...
struct base_u16 {
    ...
    KUMO_FORCE_INLINE base_u16(const __m128i _value)
        : value(_value) { }
    // Bit operations
    ...
    KUMO_FORCE_INLINE simd16<T> operator~() const {
    ...
    template <unsigned N>
    KUMO_FORCE_INLINE simd16<T> byte_right_shift() const {
        return __lsx_vbsrl_v(this->value, N);
    }

    KUMO_FORCE_INLINE uint16_t first() const {
...
struct base16 : base_u16<T> {
    ...
    KUMO_FORCE_INLINE base16()
        : base_u16<T>() { }
    KUMO_FORCE_INLINE base16(const __m128i _value)
        : base_u16<T>(_value) { }
...
struct simd16<bool> : base16<bool> {
    ...
    KUMO_FORCE_INLINE simd16()
        : base16() { }
    KUMO_FORCE_INLINE simd16(const __m128i _value)
        : base16<bool>(_value) { }

    KUMO_FORCE_INLINE bitmask_type to_bitmask() const {
        __m128i mask = __lsx_vmsknz_b(this->value);
        bitmask_type mask0 = bitmask_type(__lsx_vpickve2gr_wu(mask, 0));
        return mask0;
    }

    KUMO_FORCE_INLINE bool is_zero() const { return __lsx_bz_v(this->value); }
};
...
struct base16_numeric : base16<T> {
    ...
    static KUMO_FORCE_INLINE simd16<T> zero() { return __lsx_vldi(0); }

    template <typename Pointer>
    static KUMO_FORCE_INLINE simd16<T> load(const Pointer values) {
        return __lsx_vld(values, 0);
    }

    KUMO_FORCE_INLINE base16_numeric(const __m128i _value)
        : base16<T>(_value) { }
...
struct simd16<uint16_t> : base16_numeric<uint16_t> {
    ...
    // Copy constructor
    KUMO_FORCE_INLINE simd16(const simd16<bool> mask)
        : simd16(mask.value) { }
    ...
    template <unsigned N>
    static KUMO_FORCE_INLINE simd8<uint8_t>
    ...
    KUMO_FORCE_INLINE uint64_t sum() const {
        ...
        return uint64_t(__lsx_vpickve2gr_du(sum_u64, 0)) + uint64_t(__lsx_vpickve2gr_du(sum_u64, 1));
    }
};
...
KUMO_FORCE_INLINE simd16<bool> operator^(const simd16<bool> a,
    const simd16<bool> b) {
...
KUMO_FORCE_INLINE simd16<uint16_t> as_vector_u16(const simd16<bool> x) {
    return x.value;
}
