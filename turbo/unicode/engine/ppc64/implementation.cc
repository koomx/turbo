...
namespace turbo {
    namespace UNICODE_IMPLEMENTATION {
         ...
         [[nodiscard]] int
        UnicodeImplementPpc64::detect_encodings(const char* input,
         ...
         [[nodiscard]] bool
        UnicodeImplementPpc64::validate_utf8(const char* buf, size_t len) const noexcept {
            return ppc64::utf8_validation::generic_validate_utf8(buf, len);
        }

         [[nodiscard]] UnicodeResult UnicodeImplementPpc64::validate_utf8_with_errors(
            const char* buf, size_t len) const noexcept {
            return ppc64::utf8_validation::generic_validate_utf8_with_errors(buf, len);
        }

         [[nodiscard]] bool
        UnicodeImplementPpc64::validate_ascii(const char* buf, size_t len) const noexcept {
            return ppc64::ascii_validation::generic_validate_ascii(buf, len);
        }

         [[nodiscard]] UnicodeResult UnicodeImplementPpc64::validate_ascii_with_errors(
            const char* buf, size_t len) const noexcept {
            return ppc64::ascii_validation::generic_validate_ascii_with_errors(buf, len);
        }
         [[nodiscard]] bool
        UnicodeImplementPpc64::validate_utf16le_as_ascii(const char16_t* buf,
         ...
         [[nodiscard]] bool
        UnicodeImplementPpc64::validate_utf16be_as_ascii(const char16_t* buf,
            size_t len) const noexcept {
         ...
         [[nodiscard]] bool
        UnicodeImplementPpc64::validate_utf16le(const char16_t* buf,
            size_t len) const noexcept {
         ...
         [[nodiscard]] bool
        UnicodeImplementPpc64::validate_utf16be(const char16_t* buf,
            size_t len) const noexcept {
            return validate_utf16be_with_errors(buf, len).is_ok();
        }

        void UnicodeImplementPpc64::to_well_formed_utf16le(const char16_t* input, size_t len,
            char16_t* output) const noexcept {
            return scalar::utf16::to_well_formed_utf16<Endian::little>(input, len,
                output);
        }

        void UnicodeImplementPpc64::to_well_formed_utf16be(const char16_t* input, size_t len,
            char16_t* output) const noexcept {
            return scalar::utf16::to_well_formed_utf16<Endian::big>(input, len,
                output);
        }

         [[nodiscard]] UnicodeResult UnicodeImplementPpc64::validate_utf16le_with_errors(
         ...
         [[nodiscard]] UnicodeResult UnicodeImplementPpc64::validate_utf16be_with_errors(
            const char16_t* buf, size_t len) const noexcept {
         ...
         [[nodiscard]] bool
        UnicodeImplementPpc64::validate_utf32(const char32_t* buf, size_t len) const noexcept {
            return utf32::validate(buf, len);
        }

         [[nodiscard]] UnicodeResult UnicodeImplementPpc64::validate_utf32_with_errors(
            const char32_t* buf, size_t len) const noexcept {
            return utf32::validate_with_errors(buf, len);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::convert_latin1_to_utf8(
         ...
         [[nodiscard]] size_t UnicodeImplementPpc64::convert_latin1_to_utf16le(
         ...
         [[nodiscard]] size_t UnicodeImplementPpc64::convert_latin1_to_utf16be(
            const char* buf, size_t len, char16_t* utf16_output) const noexcept {
         ...
         [[nodiscard]] size_t UnicodeImplementPpc64::convert_latin1_to_utf32(
         ...
         [[nodiscard]] size_t UnicodeImplementPpc64::convert_utf8_to_latin1(
         ...
         [[nodiscard]] UnicodeResult UnicodeImplementPpc64::convert_utf8_to_latin1_with_errors(
            const char* buf, size_t len, char* latin1_output) const noexcept {
            utf8_to_latin1::validating_transcoder converter;
            return converter.convert_with_errors(buf, len, latin1_output);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::convert_valid_utf8_to_latin1(
            const char* buf, size_t len, char* latin1_output) const noexcept {
            return ppc64::utf8_to_latin1::convert_valid(buf, len, latin1_output);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::convert_utf8_to_utf16le(
            const char* buf, size_t len, char16_t* utf16_output) const noexcept {
            utf8_to_utf16::validating_transcoder converter;
            return converter.convert<Endian::little>(buf, len, utf16_output);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::convert_utf8_to_utf16be(
            const char* buf, size_t len, char16_t* utf16_output) const noexcept {
            utf8_to_utf16::validating_transcoder converter;
            return converter.convert<Endian::big>(buf, len, utf16_output);
        }

         [[nodiscard]] UnicodeResult UnicodeImplementPpc64::convert_utf8_to_utf16le_with_errors(
            const char* buf, size_t len, char16_t* utf16_output) const noexcept {
            utf8_to_utf16::validating_transcoder converter;
         ...
         [[nodiscard]] UnicodeResult UnicodeImplementPpc64::convert_utf8_to_utf16be_with_errors(
            const char* buf, size_t len, char16_t* utf16_output) const noexcept {
            utf8_to_utf16::validating_transcoder converter;
            return converter.convert_with_errors<Endian::big>(buf, len, utf16_output);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::convert_valid_utf8_to_utf16le(
            const char* buf, size_t len, char16_t* utf16_output) const noexcept {
            return utf8_to_utf16::convert_valid<Endian::little>(buf, len,
                utf16_output);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::convert_valid_utf8_to_utf16be(
            const char* buf, size_t len, char16_t* utf16_output) const noexcept {
            return utf8_to_utf16::convert_valid<Endian::big>(buf, len, utf16_output);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::convert_utf8_to_utf32(
            const char* buf, size_t len, char32_t* utf32_output) const noexcept {
            utf8_to_utf32::validating_transcoder converter;
            return converter.convert(buf, len, utf32_output);
        }

         [[nodiscard]] UnicodeResult UnicodeImplementPpc64::convert_utf8_to_utf32_with_errors(
            const char* buf, size_t len, char32_t* utf32_output) const noexcept {
            utf8_to_utf32::validating_transcoder converter;
            return converter.convert_with_errors(buf, len, utf32_output);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::convert_valid_utf8_to_utf32(
            const char* input, size_t size, char32_t* utf32_output) const noexcept {
            return utf8_to_utf32::convert_valid(input, size, utf32_output);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::convert_utf16le_to_latin1(
         ...
         [[nodiscard]] size_t UnicodeImplementPpc64::convert_utf16be_to_latin1(
            const char16_t* buf, size_t len, char* latin1_output) const noexcept {
        ...
        UnicodeImplementPpc64::convert_utf16le_to_latin1_with_errors(
            const char16_t* buf, size_t len, char* latin1_output) const noexcept {
         ...
         [[nodiscard]] UnicodeResult
        UnicodeImplementPpc64::convert_utf16be_to_latin1_with_errors(
            const char16_t* buf, size_t len, char* latin1_output) const noexcept {
         ...
         [[nodiscard]] size_t UnicodeImplementPpc64::convert_valid_utf16be_to_latin1(
            const char16_t* buf, size_t len, char* latin1_output) const noexcept {
            // optimization opportunity: we could provide an optimized function.
            return convert_utf16be_to_latin1(buf, len, latin1_output);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::convert_valid_utf16le_to_latin1(
            const char16_t* buf, size_t len, char* latin1_output) const noexcept {
            // optimization opportunity: we could provide an optimized function.
            return convert_utf16le_to_latin1(buf, len, latin1_output);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::convert_utf16le_to_utf8(
         ...
         [[nodiscard]] size_t UnicodeImplementPpc64::convert_utf16be_to_utf8(
            const char16_t* buf, size_t len, char* utf8_output) const noexcept {
         ...
         [[nodiscard]] UnicodeResult UnicodeImplementPpc64::convert_utf16le_to_utf8_with_errors(
            const char16_t* buf, size_t len, char* utf8_output) const noexcept {
         ...
         [[nodiscard]] UnicodeResult UnicodeImplementPpc64::convert_utf16be_to_utf8_with_errors(
            const char16_t* buf, size_t len, char* utf8_output) const noexcept {
         ...
         [[nodiscard]] size_t UnicodeImplementPpc64::convert_valid_utf16le_to_utf8(
            const char16_t* buf, size_t len, char* utf8_output) const noexcept {
            return convert_utf16le_to_utf8(buf, len, utf8_output);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::convert_valid_utf16be_to_utf8(
            const char16_t* buf, size_t len, char* utf8_output) const noexcept {
            return convert_utf16be_to_utf8(buf, len, utf8_output);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::convert_utf32_to_latin1(
         ...
         [[nodiscard]] UnicodeResult UnicodeImplementPpc64::convert_utf32_to_latin1_with_errors(
            const char32_t* buf, size_t len, char* latin1_output) const noexcept {
            return convert_with_errors_impl(
         ...
         [[nodiscard]] size_t UnicodeImplementPpc64::convert_valid_utf32_to_latin1(
            const char32_t* buf, size_t len, char* latin1_output) const noexcept {
         ...
         [[nodiscard]] size_t UnicodeImplementPpc64::convert_utf32_to_utf8(
         ...
         [[nodiscard]] UnicodeResult UnicodeImplementPpc64::convert_utf32_to_utf8_with_errors(
            const char32_t* buf, size_t len, char* utf8_output) const noexcept {
            return convert_with_errors_impl(
         ...
         [[nodiscard]] size_t UnicodeImplementPpc64::convert_valid_utf32_to_utf8(
            const char32_t* buf, size_t len, char* utf8_output) const noexcept {
         ...
         [[nodiscard]] size_t UnicodeImplementPpc64::convert_utf32_to_utf16le(
         ...
         [[nodiscard]] size_t UnicodeImplementPpc64::convert_utf32_to_utf16be(
            const char32_t* buf, size_t len, char16_t* utf16_output) const noexcept {
         ...
         [[nodiscard]] UnicodeResult UnicodeImplementPpc64::convert_utf32_to_utf16le_with_errors(
            const char32_t* buf, size_t len, char16_t* utf16_output) const noexcept {
         ...
         [[nodiscard]] UnicodeResult UnicodeImplementPpc64::convert_utf32_to_utf16be_with_errors(
            const char32_t* buf, size_t len, char16_t* utf16_output) const noexcept {
         ...
         [[nodiscard]] size_t UnicodeImplementPpc64::convert_valid_utf32_to_utf16le(
            const char32_t* buf, size_t len, char16_t* utf16_output) const noexcept {
         ...
         [[nodiscard]] size_t UnicodeImplementPpc64::convert_valid_utf32_to_utf16be(
            const char32_t* buf, size_t len, char16_t* utf16_output) const noexcept {
         ...
         [[nodiscard]] size_t UnicodeImplementPpc64::convert_utf16le_to_utf32(
         ...
         [[nodiscard]] size_t UnicodeImplementPpc64::convert_utf16be_to_utf32(
            const char16_t* buf, size_t len, char32_t* utf32_output) const noexcept {
         ...
         [[nodiscard]] UnicodeResult UnicodeImplementPpc64::convert_utf16le_to_utf32_with_errors(
            const char16_t* buf, size_t len, char32_t* utf32_output) const noexcept {
            return convert_with_errors_impl(
         ...
         [[nodiscard]] UnicodeResult UnicodeImplementPpc64::convert_utf16be_to_utf32_with_errors(
            const char16_t* buf, size_t len, char32_t* utf32_output) const noexcept {
            return convert_with_errors_impl(
         ...
         [[nodiscard]] size_t UnicodeImplementPpc64::convert_valid_utf16le_to_utf32(
            const char16_t* buf, size_t len, char32_t* utf32_output) const noexcept {
            return convert_utf16le_to_utf32(buf, len, utf32_output);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::convert_valid_utf16be_to_utf32(
            const char16_t* buf, size_t len, char32_t* utf32_output) const noexcept {
            return convert_utf16be_to_utf32(buf, len, utf32_output);
        }

        void UnicodeImplementPpc64::change_endianness_utf16(const char16_t* input,
            size_t length,
            char16_t* output) const noexcept {
            utf16::change_endianness_utf16(input, length, output);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::count_utf16le(
            const char16_t* input, size_t length) const noexcept {
            return utf16::count_code_points<Endian::little>(input, length);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::count_utf16be(
            const char16_t* input, size_t length) const noexcept {
            return utf16::count_code_points<Endian::big>(input, length);
        }

         [[nodiscard]] size_t
        UnicodeImplementPpc64::count_utf8(const char* input, size_t length) const noexcept {
            return utf8::count_code_points(input, length);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::latin1_length_from_utf8(
            const char* buf, size_t len) const noexcept {
            return count_utf8(buf, len);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::utf8_length_from_latin1(
         ...
         [[nodiscard]] size_t UnicodeImplementPpc64::utf8_length_from_utf16le(
            const char16_t* input, size_t length) const noexcept {
            return utf16::utf8_length_from_utf16<Endian::little>(input, length);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::utf8_length_from_utf16be(
            const char16_t* input, size_t length) const noexcept {
            return utf16::utf8_length_from_utf16<Endian::big>(input, length);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::utf32_length_from_utf16le(
            const char16_t* input, size_t length) const noexcept {
            return utf16::utf32_length_from_utf16<Endian::little>(input, length);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::utf32_length_from_utf16be(
            const char16_t* input, size_t length) const noexcept {
            return utf16::utf32_length_from_utf16<Endian::big>(input, length);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::utf16_length_from_utf8(
            const char* input, size_t length) const noexcept {
            return utf8::utf16_length_from_utf8(input, length);
        }
         [[nodiscard]] UnicodeResult
        UnicodeImplementPpc64::utf8_length_from_utf16le_with_replacement(
            const char16_t* input, size_t length) const noexcept {
         ...
         [[nodiscard]] UnicodeResult
        UnicodeImplementPpc64::utf8_length_from_utf16be_with_replacement(
            const char16_t* input, size_t length) const noexcept {
            return scalar::utf16::utf8_length_from_utf16_with_replacement<
         ...
         [[nodiscard]] size_t
        UnicodeImplementPpc64::convert_utf16le_to_utf8_with_replacement(
         ...
         [[nodiscard]] size_t
        UnicodeImplementPpc64::convert_utf16be_to_utf8_with_replacement(
            const char16_t* input, size_t length, char* utf8_buffer) const noexcept {
            return utf16_to_utf8::convert_with_replacement_via(
                [this](const char16_t* b, size_t l, char* o) {
         ...
         [[nodiscard]] size_t UnicodeImplementPpc64::utf8_length_from_utf32(
            const char32_t* input, size_t length) const noexcept {
            return utf32::utf8_length_from_utf32(input, length);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::utf16_length_from_utf32(
            const char32_t* input, size_t length) const noexcept {
            return scalar::utf32::utf16_length_from_utf32(input, length);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::utf32_length_from_utf8(
            const char* input, size_t length) const noexcept {
            return utf8::count_code_points(input, length);
        }

         [[nodiscard]] size_t UnicodeImplementPpc64::maximal_binary_length_from_base64(
            const char* input, size_t length) const noexcept {
            return scalar::base64::maximal_binary_length_from_base64(input, length);
        }

         [[nodiscard]] UnicodeResult UnicodeImplementPpc64::base64_to_binary(
         ...
         [[nodiscard]] full_result UnicodeImplementPpc64::base64_to_binary_details(
            const char* input, size_t length, char* output, Base64Options options,
            last_chunk_handling_options last_chunk_options) const noexcept {
            if (options & base64_default_or_url) {
                if (options == Base64Options::base64_default_or_url_accept_garbage) {
        ...
        size_t UnicodeImplementPpc64::binary_to_base64(const char* input, size_t length,
            char* output,
        ...
        size_t UnicodeImplementPpc64::binary_to_base64_with_lines(
        ...
        const char* UnicodeImplementPpc64::find(const char* start, const char* end,
            char character) const noexcept {
            return util::find(start, end, character);
        }

        const char16_t* UnicodeImplementPpc64::find(const char16_t* start, const char16_t* end,
            char16_t character) const noexcept {
            return util::find(start, end, character);
        }

#ifdef UNICODE_INTERNAL_TESTS
        std::vector<UnicodeImplementPpc64::TestProcedure>
        UnicodeImplementPpc64::internal_tests() const {
#define entry(proc) \
    TestProcedure { \
        #proc, proc \
    }
...
#undef entry
    ...
    static turbo::UnicodeImplement *get_ppc64_instance() {
        static ppc64::UnicodeImplementPpc64 ins;
        return &ins;
    }
} // namespace turbo
