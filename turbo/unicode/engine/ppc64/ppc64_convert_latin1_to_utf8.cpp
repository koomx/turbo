...
ppc64_convert_latin1_to_utf8(const char* latin_input,
...
#else
    const auto latin_1_half_into_u16_byte_mask = vector_u8(0, 16, 1, 16, 2, 16, 3, 16, 4, 16, 5, 16, 6, 16, 7, 16);
    const auto latin_2_half_into_u16_byte_mask = vector_u8(8, 16, 9, 16, 10, 16, 11, 16, 12, 16, 13, 16, 14, 16, 15, 16);
    ...
    while (end - latin_input >= 16 + 8) {
        ...
        const vector_u16 v_u16_latin_1_half = as_vector_u16(latin_1_half_into_u16_byte_mask.lookup_32(v_latin, v_00));

        // aaaa_aaaa_bbbb_bbbb -> BBBB_BBBB
        const vector_u16 v_u16_latin_2_half = as_vector_u16(latin_2_half_into_u16_byte_mask.lookup_32(v_latin, v_00));
