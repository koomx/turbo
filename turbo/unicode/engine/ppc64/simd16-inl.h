...
struct simd16<bool> : base16<bool> {
    ...
    KUMO_FORCE_INLINE simd16(const vector_type _value)
        : base16<bool>(_value) { }
    ...
    KUMO_FORCE_INLINE simd16<bool>& operator|=(const simd16<bool> rhs) {
...
struct base16_numeric : base16<T> {
    ...
    static KUMO_FORCE_INLINE simd16<T> zero() { return splat(0); }

    template <typename U>
    static KUMO_FORCE_INLINE simd16<T> load(const U* ptr) {
        return vec_xl(0, reinterpret_cast<const T*>(ptr));
    }

    KUMO_FORCE_INLINE base16_numeric()
        : base16<T>() { }
    KUMO_FORCE_INLINE base16_numeric(const vector_type _value)
        : base16<T>(_value) { }
