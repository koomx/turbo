...
KUMO_FORCE_INLINE void utf16fix_block_rvv(char16_t* out, const char16_t* in,
    ...
    if (__riscv_vfirst_m_b2(illseq, vl) >= 0) {
        ...
        if (vlmax) {
            ...
            vuint8mf2_t vlb_illseq = __riscv_vlmul_trunc_u8mf2(__riscv_vreinterpret_u8m1(lb_illseq));
            lb_illseq_right_shifted = __riscv_vreinterpret_b2(__riscv_vlmul_ext_u8m1(__riscv_vmacc_vx_u8mf2(
        ...
        vbool2_t block_illseq = __riscv_vmor_mm_b2(__riscv_vmandn_mm_b2(block_is_low, lb_is_high, vl),
