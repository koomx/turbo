...
#include <turbo/unicode/engine/westmere/internal/loader.cpp>
#endif // SIMDUTF_FEATURE_UTF8

#if SIMDUTF_FEATURE_UTF16
#include <turbo/unicode/engine/westmere/sse_utf16fix.cpp>
#endif // SIMDUTF_FEATURE_UTF16
#if SIMDUTF_FEATURE_UTF16 || SIMDUTF_FEATURE_DETECT_ENCODING
#include <turbo/unicode/engine/westmere/sse_validate_utf16.cpp>
#endif // SIMDUTF_FEATURE_UTF16 || SIMDUTF_FEATURE_DETECT_ENCODING

#if SIMDUTF_FEATURE_UTF8 && SIMDUTF_FEATURE_LATIN1
#include <turbo/unicode/engine/westmere/sse_convert_latin1_to_utf8.cpp>
#endif // SIMDUTF_FEATURE_UTF8 && SIMDUTF_FEATURE_LATIN1

#if SIMDUTF_FEATURE_UTF16 && SIMDUTF_FEATURE_LATIN1
#include <turbo/unicode/engine/westmere/sse_convert_latin1_to_utf16.cpp>
#endif // SIMDUTF_FEATURE_UTF16 && SIMDUTF_FEATURE_LATIN1

#if SIMDUTF_FEATURE_UTF32 && SIMDUTF_FEATURE_LATIN1
#include <turbo/unicode/engine/westmere/sse_convert_latin1_to_utf32.cpp>
#endif // SIMDUTF_FEATURE_UTF32 && SIMDUTF_FEATURE_LATIN1

#if SIMDUTF_FEATURE_UTF8 && SIMDUTF_FEATURE_UTF16
#include <turbo/unicode/engine/westmere/sse_convert_utf8_to_utf16.cpp>
#endif // SIMDUTF_FEATURE_UTF8 && SIMDUTF_FEATURE_UTF16

#if SIMDUTF_FEATURE_UTF8 && SIMDUTF_FEATURE_UTF32
#include <turbo/unicode/engine/westmere/sse_convert_utf8_to_utf32.cpp>
#endif // SIMDUTF_FEATURE_UTF8 && SIMDUTF_FEATURE_UTF32

#if SIMDUTF_FEATURE_UTF8 && SIMDUTF_FEATURE_LATIN1
#include <turbo/unicode/engine/westmere/sse_convert_utf8_to_latin1.cpp>
#endif // SIMDUTF_FEATURE_UTF8 && SIMDUTF_FEATURE_LATIN1

#if SIMDUTF_FEATURE_UTF16 && SIMDUTF_FEATURE_LATIN1
#include <turbo/unicode/engine/westmere/sse_convert_utf16_to_latin1.cpp>
#endif // SIMDUTF_FEATURE_UTF16 && SIMDUTF_FEATURE_LATIN1

#if SIMDUTF_FEATURE_UTF8 && SIMDUTF_FEATURE_UTF16
#include <turbo/unicode/engine/westmere/sse_convert_utf16_to_utf8.cpp>
#endif // SIMDUTF_FEATURE_UTF8 && SIMDUTF_FEATURE_UTF16

#if SIMDUTF_FEATURE_UTF16 && SIMDUTF_FEATURE_UTF32
#include <turbo/unicode/engine/westmere/sse_convert_utf16_to_utf32.cpp>
#endif // SIMDUTF_FEATURE_UTF16 && SIMDUTF_FEATURE_UTF32

#if SIMDUTF_FEATURE_UTF32 && SIMDUTF_FEATURE_LATIN1
#include <turbo/unicode/engine/westmere/sse_convert_utf32_to_latin1.cpp>
#endif // SIMDUTF_FEATURE_UTF32 && SIMDUTF_FEATURE_LATIN1

#if SIMDUTF_FEATURE_UTF8 && SIMDUTF_FEATURE_UTF32
#include <turbo/unicode/engine/westmere/sse_convert_utf32_to_utf8.cpp>
#endif // SIMDUTF_FEATURE_UTF8 && SIMDUTF_FEATURE_UTF32

#if SIMDUTF_FEATURE_UTF16 && SIMDUTF_FEATURE_UTF32
#include <turbo/unicode/engine/westmere/sse_convert_utf32_to_utf16.cpp>
#endif // SIMDUTF_FEATURE_UTF16 && SIMDUTF_FEATURE_UTF32
...
#if SIMDUTF_FEATURE_UTF8 || SIMDUTF_FEATURE_DETECT_ENCODING
#include <turbo/unicode/engine/generic/utf8_validation/utf8_lookup4_algorithm.h>
#include <turbo/unicode/engine/generic/utf8_validation/utf8_validator.h>
#endif // SIMDUTF_FEATURE_UTF8 || SIMDUTF_FEATURE_DETECT_ENCODING
#if SIMDUTF_FEATURE_ASCII
#include <turbo/unicode/engine/generic/ascii_validation.h>
#endif // SIMDUTF_FEATURE_ASCII

#if SIMDUTF_FEATURE_UTF8 && SIMDUTF_FEATURE_UTF16
  // transcoding from UTF-8 to UTF-16
#include <turbo/unicode/engine/generic/utf8_to_utf16/valid_utf8_to_utf16.h>
#include <turbo/unicode/engine/generic/utf8_to_utf16/utf8_to_utf16.h>
#include <turbo/unicode/engine/generic/utf8/utf16_length_from_utf8_bytemask.h>
  // transcoding from UTF-16 to UTF-8
#include <turbo/unicode/engine/generic/utf16_to_utf8/utf16_to_utf8_with_replacement.h>
#endif // SIMDUTF_FEATURE_UTF8 && SIMDUTF_FEATURE_UTF16

#if SIMDUTF_FEATURE_UTF8 && SIMDUTF_FEATURE_UTF32
#include <turbo/unicode/engine/generic/utf8_to_utf32/valid_utf8_to_utf32.h>
#include <turbo/unicode/engine/generic/utf8_to_utf32/utf8_to_utf32.h>
#include <turbo/unicode/engine/generic/utf32.h>
#endif // SIMDUTF_FEATURE_UTF8 && SIMDUTF_FEATURE_UTF32

#if SIMDUTF_FEATURE_UTF8
#include <turbo/unicode/engine/generic/utf8.h>
#endif // SIMDUTF_FEATURE_UTF8
#if SIMDUTF_FEATURE_UTF16
#include <turbo/unicode/engine/generic/utf16.h>
#include <turbo/unicode/engine/generic/utf16/utf8_length_from_utf16_bytemask.h>
#endif // SIMDUTF_FEATURE_UTF16
#if SIMDUTF_FEATURE_UTF16 || SIMDUTF_FEATURE_DETECT_ENCODING
#include <turbo/unicode/engine/generic/validate_utf16.h>
#endif // SIMDUTF_FEATURE_UTF16 || SIMDUTF_FEATURE_DETECT_ENCODING
#if SIMDUTF_FEATURE_UTF8 && SIMDUTF_FEATURE_LATIN1
#include <turbo/unicode/engine/generic/utf8_to_latin1/utf8_to_latin1.h>
#include <turbo/unicode/engine/generic/utf8_to_latin1/valid_utf8_to_latin1.h>
#endif // SIMDUTF_FEATURE_UTF8 && SIMDUTF_FEATURE_LATIN1

#if SIMDUTF_FEATURE_UTF32 || SIMDUTF_FEATURE_DETECT_ENCODING
#include <turbo/unicode/engine/generic/validate_utf32.h>
#endif // SIMDUTF_FEATURE_UTF32 || SIMDUTF_FEATURE_DETECT_ENCODING

#if SIMDUTF_FEATURE_BASE64
#include <turbo/unicode/engine/generic/base64.h>
#include <turbo/unicode/engine/generic/find.h>
#include <turbo/unicode/engine/generic/base64lengths.h>
#endif // SIMDUTF_FEATURE_BASE64
    ...
    namespace SIMDUTF_IMPLEMENTATION {
        ...
        implementation::detect_encodings(const char* input,
            ...
            while (reader.has_full_block()) {
                ...
                const uint32_t surrogates_bitmask = (surrogates_wordmask_hi.to_bitmask() << 16) | surrogates_wordmask_lo.to_bitmask();
                ...
                currentoffsetmax = _mm_max_epu32(_mm_add_epi32(in.chunks[0], offset), currentoffsetmax);
                currentmax = _mm_max_epu32(in.chunks[1], currentmax);
                currentoffsetmax = _mm_max_epu32(_mm_add_epi32(in.chunks[1], offset), currentoffsetmax);
                currentmax = _mm_max_epu32(in.chunks[2], currentmax);
                currentoffsetmax = _mm_max_epu32(_mm_add_epi32(in.chunks[2], offset), currentoffsetmax);
                currentmax = _mm_max_epu32(in.chunks[3], currentmax);
                currentoffsetmax = _mm_max_epu32(_mm_add_epi32(in.chunks[3], offset), currentoffsetmax);
        ...
        implementation::validate_utf16le(const char16_t* buf,
            ...
            const auto res = westmere::utf16::validate_utf16_with_errors<endianness::LITTLE>(buf, len);
            if (res.is_err()) {
                return false;
            }
        ...
        implementation::validate_utf16be(const char16_t* buf,
            ...
            const auto res = westmere::utf16::validate_utf16_with_errors<endianness::BIG>(buf, len);
            if (res.is_err()) {
                return false;
            }
        ...
        simdutf_warn_unused result implementation::validate_utf16le_with_errors(
            ...
            const result res = westmere::utf16::validate_utf16_with_errors<endianness::LITTLE>(buf, len);
            if (res.count != len) {
                const result scalar_res = scalar::utf16::validate_with_errors<endianness::LITTLE>(
        ...
        simdutf_warn_unused result implementation::validate_utf16be_with_errors(
            const char16_t* buf, size_t len) const noexcept {
            const result res = westmere::utf16::validate_utf16_with_errors<endianness::BIG>(buf, len);
            if (res.count != len) {
        ...
        implementation::convert_utf16le_to_latin1_with_errors(
            const char16_t* buf, size_t len, char* latin1_output) const noexcept {
            std::pair<result, char*> ret = sse_convert_utf16_to_latin1_with_errors<endianness::LITTLE>(
        ...
        implementation::convert_utf16be_to_latin1_with_errors(
            const char16_t* buf, size_t len, char* latin1_output) const noexcept {
            std::pair<result, char*> ret = sse_convert_utf16_to_latin1_with_errors<endianness::BIG>(buf, len,
                latin1_output);
            if (ret.first.error) {
                return ret.first;
            } // Can return directly since scalar fallback already found correct
        ...
        simdutf_warn_unused result implementation::convert_utf16le_to_utf8_with_errors(
            ...
            std::pair<result, char*> ret = westmere::sse_convert_utf16_to_utf8_with_errors<endianness::LITTLE>(
                buf, len, utf8_output);
            if (ret.first.error) {
                return ret.first;
            } // Can return directly since scalar fallback already found correct
        ...
        simdutf_warn_unused result implementation::convert_utf16be_to_utf8_with_errors(
            ...
            // ret.first.count is always the position in the buffer, not the number of
            // code units written even if finished
            std::pair<result, char*> ret = westmere::sse_convert_utf16_to_utf8_with_errors<endianness::BIG>(
                buf, len, utf8_output);
            if (ret.first.error) {
                return ret.first;
            } // Can return directly since scalar fallback already found correct
        ...
        simdutf_warn_unused result implementation::convert_utf32_to_latin1_with_errors(
            ...
            // ret.first.count is always the position in the buffer, not the number of
            // code units written even if finished
            std::pair<result, char*> ret = westmere::sse_convert_utf32_to_latin1_with_errors(buf, len,
                latin1_output);
        ...
        simdutf_warn_unused result implementation::convert_utf16le_to_utf32_with_errors(
            ...
            // ret.first.count is always the position in the buffer, not the number of
            // code units written even if finished
            std::pair<result, char32_t*> ret = westmere::sse_convert_utf16_to_utf32_with_errors<endianness::LITTLE>(
        ...
        simdutf_warn_unused result implementation::convert_utf16be_to_utf32_with_errors(
            ...
            // ret.first.count is always the position in the buffer, not the number of
            // code units written even if finished
            std::pair<result, char32_t*> ret = westmere::sse_convert_utf16_to_utf32_with_errors<endianness::BIG>(
                buf, len, utf32_output);
            if (ret.first.error) {
                return ret.first;
            } // Can return directly since scalar fallback already found correct
        ...
        simdutf_warn_unused result implementation::convert_utf32_to_utf16le_with_errors(
            ...
            // ret.first.count is always the position in the buffer, not the number of
            // code units written even if finished
            std::pair<result, char16_t*> ret = westmere::sse_convert_utf32_to_utf16_with_errors<endianness::LITTLE>(
        ...
        simdutf_warn_unused result implementation::convert_utf32_to_utf16be_with_errors(
            ...
            // ret.first.count is always the position in the buffer, not the number of
            // code units written even if finished
            std::pair<result, char16_t*> ret = westmere::sse_convert_utf32_to_utf16_with_errors<endianness::BIG>(
                buf, len, utf16_output);
            if (ret.first.count != len) {
            ...
            if (answer >= 2048) { // long strings optimization
                ...
                while (i + sizeof(__m128i) <= len) {
                    ...
                    for (; i + 4 * sizeof(__m128i) <= max_i; i += 4 * sizeof(__m128i)) {
                        ...
                        __m128i input12 = _mm_add_epi8(_mm_cmpgt_epi8(_mm_setzero_si128(), input1),
                            _mm_cmpgt_epi8(_mm_setzero_si128(), input2));
                        __m128i input34 = _mm_add_epi8(_mm_cmpgt_epi8(_mm_setzero_si128(), input3),
                    ...
                    two_64bits = _mm_add_epi64(two_64bits, _mm_sad_epu8(runner, _mm_setzero_si128()));
                }
                answer += _mm_extract_epi64(two_64bits, 0) + _mm_extract_epi64(two_64bits, 1);
