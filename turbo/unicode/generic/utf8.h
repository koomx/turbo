            ...
            namespace utf8 {
                ...
                KUMO_FORCE_INLINE size_t count_code_points(const char* in, size_t size) {
                    ...
                    for (; pos + 64 <= size; pos += 64) {
                        ...
                        count += popcount(utf8_continuation_mask);
                    }
                ...
                KUMO_FORCE_INLINE size_t utf16_length_from_utf8(const char* in,
                    ...
                    for (; pos + 64 <= size; pos += 64) {
                        ...
                        // leading bytes).
                        count += 64 - popcount(utf8_continuation_mask);
                        uint64_t utf8_4byte = input.gteq_unsigned(240);
                        count += turbo::popcount(utf8_4byte);
                    }
