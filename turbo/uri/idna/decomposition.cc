...
namespace turbo::idna {
     ...
     const uint8_t IdnaTables::decomposition_index[4352] = {
    ...
    const uint16_t IdnaTables::decomposition_block[67][257] = {
    ...
    const char32_t IdnaTables::decomposition_data[9102] = {
