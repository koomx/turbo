...
namespace turbo {
    namespace uri_internal {
        ...
        template <typename T>
        struct is_transparent_comparison<T, std::void_t<typename T::is_transparent>>
            : std::true_type { };

        template <typename T>
        inline constexpr bool is_transparent_comparison_v = is_transparent_comparison<T>::value;

    }  // namespace uri_internal

    /// QueryMapValueCompare
    ///
    /// Our adapter for the comparison function in the template parameters.
    ///
    template <typename Key, typename Value, typename Compare>
    class QueryMapValueCompare : public Compare {
    public:
        explicit QueryMapValueCompare(const Compare& x)
            : Compare(x) {
        }
    ...
    ///
    /// Note that with vector_set, vector_multiset, vector_map, QueryMap
    ...
    class QueryMap : protected QueryMapValueCompare<Key, std::pair<Key, T>, Compare>,
                           public RandomAccessContainer {
    public:
        typedef RandomAccessContainer base_type;
        typedef QueryMap<Key, T, Compare, RandomAccessContainer> this_type;
        typedef Key key_type;
        typedef T mapped_type;
        typedef std::pair<Key, T> value_type;
        typedef Compare key_compare;
        typedef QueryMapValueCompare<Key, value_type, Compare> value_compare;
    ...
    public:
        ...
        explicit QueryMap(const key_compare& comp);

        QueryMap(const this_type& x);

        QueryMap(this_type&& x);

        QueryMap(std::initializer_list<value_type> ilist, const key_compare& compare = key_compare());

        template <typename InputIterator>
        QueryMap(InputIterator first, InputIterator last);
        ...
        template <typename InputIterator>
        QueryMap(InputIterator first, InputIterator last, const key_compare& compare);
        ...
        template <typename KX, typename Cmp = Compare,
            std::enable_if_t<!(std::is_convertible_v<KX&&, iterator> || std::is_convertible_v<KX&&, const_iterator>)
                    && uri_internal::is_transparent_comparison_v<Cmp>,
                bool> = true>
        ...
        template <typename KX, typename Cmp = Compare, std::enable_if_t<uri_internal::is_transparent_comparison_v<Cmp>, bool> = true>
    ...
    inline QueryMap<K, T, C, RAC>::QueryMap()
        : value_compare(C())
        , base_type() {
    }

    template <typename K, typename T, typename C, typename RAC>
    inline QueryMap<K, T, C, RAC>::QueryMap(const key_compare& comp)
        : value_compare(comp)
        , base_type() {
        // Empty
    }
    ...
    template <typename K, typename T, typename C, typename RAC>
    inline QueryMap<K, T, C, RAC>::QueryMap(const this_type& x)
        : value_compare(x)
        , base_type(x) {
        // Empty
    }
    ...
    template <typename K, typename T, typename C, typename RAC>
    inline QueryMap<K, T, C, RAC>::QueryMap(this_type&& x)
        // careful to only copy / move the distinct base sub-objects of x:
        : value_compare(static_cast<value_compare&>(x))
    ...
    template <typename K, typename T, typename C, typename RAC>
    inline QueryMap<K, T, C, RAC>::QueryMap(std::initializer_list<value_type> ilist,
    ...
    template <typename K, typename T, typename C, typename RAC>
    template <typename InputIterator>
    inline QueryMap<K, T, C, RAC>::QueryMap(InputIterator first, InputIterator last)
    ...
    template <typename K, typename T, typename C, typename RAC>
    inline typename QueryMap<K, T, C, RAC>::this_type&
    QueryMap<K, T, C, RAC>::operator=(const this_type& x) {
    ...
    template <typename K, typename T, typename C, typename RAC>
    inline typename QueryMap<K, T, C, RAC>::this_type&
    QueryMap<K, T, C, RAC>::operator=(this_type&& x) {
    ...
    template <typename K, typename T, typename C, typename RAC>
    inline typename QueryMap<K, T, C, RAC>::this_type&
    QueryMap<K, T, C, RAC>::operator=(std::initializer_list<value_type> ilist) {
        base_type::clear();
        insert(ilist.begin(), ilist.end());
        return *this;
    }
    ...
    template <typename K, typename T, typename C, typename RAC>
    inline void QueryMap<K, T, C, RAC>::swap(this_type& x) {
        base_type::swap(x);
        using std::swap;
        swap(static_cast<value_compare&>(*this), static_cast<value_compare&>(x));
    }
    ...
    template <typename K, typename T, typename C, typename RAC>
    inline const typename QueryMap<K, T, C, RAC>::key_compare&
    QueryMap<K, T, C, RAC>::key_comp() const {
        return static_cast<const key_compare&>(*this);
    }

    template <typename K, typename T, typename C, typename RAC>
    inline typename QueryMap<K, T, C, RAC>::key_compare&
    QueryMap<K, T, C, RAC>::key_comp() {
        return static_cast<key_compare&>(*this);
    }

    template <typename K, typename T, typename C, typename RAC>
    inline const typename QueryMap<K, T, C, RAC>::value_compare&
    QueryMap<K, T, C, RAC>::value_comp() const {
        return static_cast<const value_compare&>(*this);
    }

    template <typename K, typename T, typename C, typename RAC>
    inline typename QueryMap<K, T, C, RAC>::value_compare&
    QueryMap<K, T, C, RAC>::value_comp() {
        return static_cast<value_compare&>(*this);
    }

    template <typename K, typename T, typename C, typename RAC>
    template <class... Args>
    inline typename QueryMap<K, T, C, RAC>::iterator
    QueryMap<K, T, C, RAC>::emplace(Args&&... args) {
    ...
    template <class... Args>
    inline typename QueryMap<K, T, C, RAC>::iterator
    QueryMap<K, T, C, RAC>::emplace_hint(const_iterator position, Args&&... args) {
        value_type value(std::forward<Args>(args)...);
    ...
    template <typename K, typename T, typename C, typename RAC>
    inline typename QueryMap<K, T, C, RAC>::iterator
    QueryMap<K, T, C, RAC>::insert(const value_type& value) {
    ...
    inline typename QueryMap<K, T, C, RAC>::iterator
    QueryMap<K, T, C, RAC>::insert(P&& otherValue) {
    ...
    template <typename K, typename T, typename C, typename RAC>
    inline typename QueryMap<K, T, C, RAC>::iterator
    QueryMap<K, T, C, RAC>::insert(const key_type& otherValue) {
    ...
    template <typename K, typename T, typename C, typename RAC>
    inline typename QueryMap<K, T, C, RAC>::iterator
    QueryMap<K, T, C, RAC>::insert(key_type&& otherValue) {
        value_type value(otherValue, mapped_type { });
        const iterator itUB(upper_bound(value.first));
        return base_type::insert(itUB, std::move(value));
    }
    ...
    template <typename K, typename T, typename C, typename RAC>
    inline typename QueryMap<K, T, C, RAC>::iterator
    QueryMap<K, T, C, RAC>::insert(const_iterator position, const value_type& value) {
    ...
    template <typename K, typename T, typename C, typename RAC>
    inline typename QueryMap<K, T, C, RAC>::iterator
    QueryMap<K, T, C, RAC>::insert(const_iterator position, value_type&& value) {
        if ((position == end()) || !value_compare::operator()(*position, value))
        // If value is <= the element at position...
        {
            if ((position == begin()) || !value_compare::operator()(value, *(position - 1)))
    ...
    template <typename K, typename T, typename C, typename RAC>
    inline void QueryMap<K, T, C, RAC>::insert(std::initializer_list<value_type> ilist) {
        insert(ilist.begin(), ilist.end());
    }

    template <typename K, typename T, typename C, typename RAC>
    template <typename InputIterator>
    inline void QueryMap<K, T, C, RAC>::insert(InputIterator first, InputIterator last) {
    ...
    template <typename K, typename T, typename C, typename RAC>
    inline typename QueryMap<K, T, C, RAC>::iterator
    QueryMap<K, T, C, RAC>::erase(const_iterator position) {
    ...
    template <typename K, typename T, typename C, typename RAC>
    inline typename QueryMap<K, T, C, RAC>::iterator
    QueryMap<K, T, C, RAC>::erase(const_iterator first, const_iterator last) {
        return base_type::erase(first, last);
    }

    template <typename K, typename T, typename C, typename RAC>
    template <typename KX>
    inline typename QueryMap<K, T, C, RAC>::size_type
    QueryMap<K, T, C, RAC>::DoErase(KX&& k) {
    ...
    template <typename K, typename T, typename C, typename RAC>
    inline typename QueryMap<K, T, C, RAC>::reverse_iterator
    QueryMap<K, T, C, RAC>::erase(const_reverse_iterator position) {
        return reverse_iterator(base_type::erase((++position).base()));
    }

    template <typename K, typename T, typename C, typename RAC>
    inline typename QueryMap<K, T, C, RAC>::reverse_iterator
    QueryMap<K, T, C, RAC>::erase(const_reverse_iterator first, const_reverse_iterator last) {
    ...
    template <typename KX>
    inline typename QueryMap<K, T, C, RAC>::iterator
    QueryMap<K, T, C, RAC>::DoFind(const KX& k) {
        const std::pair<iterator, iterator> pairIts(equal_range(k));
    ...
    template <typename K, typename T, typename C, typename RAC>
    template <typename KX>
    inline typename QueryMap<K, T, C, RAC>::const_iterator
    QueryMap<K, T, C, RAC>::DoFind(const KX& k) const {
    ...
    template <typename U, typename BinaryPredicate>
    inline typename QueryMap<K, T, C, RAC>::const_iterator
    QueryMap<K, T, C, RAC>::find_as(const U& u, BinaryPredicate predicate) const {
    ...
    template <typename U, typename BinaryPredicate>
    inline typename QueryMap<K, T, C, RAC>::iterator
    QueryMap<K, T, C, RAC>::find_as(const U& u, BinaryPredicate predicate) {
    ...
    template <typename KX>
    inline typename QueryMap<K, T, C, RAC>::size_type
    QueryMap<K, T, C, RAC>::DoCount(const KX& k) const {
        const std::pair<const_iterator, const_iterator> pairIts(equal_range(k));
    ...
    template <typename KX>
    inline typename QueryMap<K, T, C, RAC>::iterator
    QueryMap<K, T, C, RAC>::DoLowerBound(const KX& k) {
    ...
    template <typename KX>
    inline typename QueryMap<K, T, C, RAC>::const_iterator
    QueryMap<K, T, C, RAC>::DoLowerBound(const KX& k) const {
        auto comp = [this](const value_type& value, const KX& key) {
            return static_cast<const key_compare&>(*this)(value.first, key);
        };
        return std::lower_bound(begin(), end(), k, comp);
    ...
    template <typename KX>
    inline typename QueryMap<K, T, C, RAC>::iterator
    QueryMap<K, T, C, RAC>::DoUpperBound(const KX& k) {
    ...
    template <typename KX>
    inline typename QueryMap<K, T, C, RAC>::const_iterator
    QueryMap<K, T, C, RAC>::DoUpperBound(const KX& k) const {
        auto comp = [this](const KX& key, const value_type& value) {
            return static_cast<const key_compare&>(*this)(key, value.first);
        };
        return std::upper_bound(begin(), end(), k, comp);
    ...
    template <typename K, typename T, typename C, typename RAC>
    template <typename KX>
    inline std::pair<typename QueryMap<K, T, C, RAC>::iterator, typename QueryMap<K, T, C, RAC>::iterator>
    QueryMap<K, T, C, RAC>::DoEqualRange(const KX& k) {
        return std::equal_range(begin(), end(), k, internal::equal_range_comp<value_type, key_compare>(*this));
    }

    template <typename K, typename T, typename C, typename RAC>
    template <typename KX>
    inline std::pair<typename QueryMap<K, T, C, RAC>::const_iterator, typename QueryMap<K, T, C, RAC>::const_iterator>
    QueryMap<K, T, C, RAC>::DoEqualRange(const KX& k) const {
        return std::equal_range(begin(), end(), k, internal::equal_range_comp<value_type, key_compare>(*this));
    }
    ...
    template <typename KX>
    inline std::pair<typename QueryMap<K, T, C, RAC>::iterator, typename QueryMap<K, T, C, RAC>::iterator>
    QueryMap<K, T, C, RAC>::DoEqualRangeSmall(const KX& k) {
    ...
    template <typename KX>
    inline std::pair<typename QueryMap<K, T, C, RAC>::const_iterator, typename QueryMap<K, T, C, RAC>::const_iterator>
    QueryMap<K, T, C, RAC>::DoEqualRangeSmall(const KX& k) const {
    ...
    template <typename K, typename T, typename C, typename RAC>
    inline bool operator==(const QueryMap<K, T, C, RAC>& a,
        const QueryMap<K, T, C, RAC>& b) {
    ...
    template <typename K, typename T, typename C, typename RAC>
    inline void swap(QueryMap<K, T, C, RAC>& a,
        QueryMap<K, T, C, RAC>& b) {
        a.swap(b);
    }

    template<typename Key, typename T, size_t N>
    using InlinedQueryMap = QueryMap<Key, T, std::less<Key>,InlinedVector<std::pair<Key, T>, N>>;
