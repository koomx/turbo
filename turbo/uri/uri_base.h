...
namespace turbo {
     ...
     * Unlike the url_aggregator, the UriBase represents the different components
     ...
     */
    struct UriBase : turbo::UriCommonBase {
        UriBase() = default;
    ...
    inline void UriBase::update_unencoded_base_hash(std::string_view input) {
    ...
    [[nodiscard]] KUMO_FORCE_INLINE std::string UriBase::get_href() const noexcept {
