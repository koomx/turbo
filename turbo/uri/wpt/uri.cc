...
namespace turbo {
    ...
    [[nodiscard]] std::string WptUri::to_string() const {
        if (!uri_error.ok()) {
            return "null";
        }
        std::string answer;
    ...
    [[nodiscard]] bool WptUri::has_valid_domain() const noexcept {
        if (!host.has_value()) {
            return false;
        }
    ...
    void WptUri::strip_trailing_spaces_from_opaque_path() noexcept {
    ...
    [[nodiscard]] std::string WptUri::get_protocol() const noexcept {
        if (is_special()) {
    ...
    [[nodiscard]] std::string WptUri::get_host() const noexcept {
    ...
    [[nodiscard]] std::string WptUri::get_hostname() const noexcept {
        return host.value_or("");
    }

    [[nodiscard]] std::string_view WptUri::get_pathname() const noexcept {
        return path;
    }

    [[nodiscard]] std::string WptUri::get_search() const noexcept {
    ...
    [[nodiscard]] const std::string& WptUri::get_username() const noexcept {
        return username;
    }

    [[nodiscard]] const std::string& WptUri::get_password() const noexcept {
        return password;
    }

    [[nodiscard]] std::string WptUri::get_port() const noexcept {
        return port.has_value() ? std::to_string(port.value()) : "";
    }

    [[nodiscard]] std::string WptUri::get_hash() const noexcept {
    ...
    bool WptUri::set_host_or_hostname(const std::string_view input, bool override_hostname) {
        if (has_opaque_path()) {
            return false;
        }
    ...
    bool WptUri::set_host(const std::string_view input) {
        return set_host_or_hostname(input, false);
    }

    bool WptUri::set_hostname(const std::string_view input) {
        return set_host_or_hostname(input, true);
    }

    bool WptUri::set_username(const std::string_view input) {
    ...
    bool WptUri::set_password(const std::string_view input) {
        if (cannot_have_credentials_or_port()) {
            return false;
        }
    ...
    bool WptUri::set_port(const std::string_view input) {
        if (cannot_have_credentials_or_port()) {
            return false;
        }
    ...
    void WptUri::set_hash(const std::string_view input) {
        if (input.empty()) {
            hash = std::nullopt;
    ...
    void WptUri::set_search(const std::string_view input) {
        if (input.empty()) {
            query = std::nullopt;
            strip_trailing_spaces_from_opaque_path();
            return;
    ...
    bool WptUri::set_pathname(const std::string_view input) {
        if (has_opaque_path()) {
            return false;
        }
    ...
    bool WptUri::set_protocol(const std::string_view input) {
